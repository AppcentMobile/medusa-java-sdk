...
/**
 * API tests for PaymentCollectionApi
 */
@Ignore
public class PaymentCollectionApiTest {

    private final PaymentCollectionApi api = new PaymentCollectionApi();
     ...
     */
    @Test
    public void getPaymentCollectionsPaymentCollectionTest() throws Exception {
        String id = null;
        String expand = null;
        String fields = null;

...
/**
 * API tests for ShippingOptionApi
 */
@Ignore
public class ShippingOptionApiTest {

    private final ShippingOptionApi api = new ShippingOptionApi();
     ...
     */
    @Test
    public void getShippingOptionsTest() throws Exception {

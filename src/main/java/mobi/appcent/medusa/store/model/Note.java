 ...
 */
@Schema(description = "Notes are elements which we can use in association with different resources to allow users to describe additional information in relation to these.")
...
public class Note {
   ...
   * @return id
  **/
  @Schema(example = "note_01G8TM8ENBMC7R90XRR1G6H26Q", required = true, description = "The note's ID")
  public String getId() {
    return id;
  }
  ...
  public Note resourceType(String resourceType) {
   ...
   * @return resourceType
  **/
  @Schema(example = "order", required = true, description = "The type of resource that the Note refers to.")
  ...
  public Note resourceId(String resourceId) {
   ...
   * @return resourceId
  **/
  @Schema(example = "order_01G8TJSYT9M6AVS5N4EMNFS1EK", required = true, description = "The ID of the resource that the Note refers to.")
   ...
   * @return value
  **/
  @Schema(example = "This order must be fulfilled on Monday", required = true, description = "The contents of the note.")
  ...
  public Note authorId(String authorId) {
   ...
   * @return authorId
  **/
  @Schema(example = "usr_01G1G5V26F5TB3GPAPNJ8X1S3V", required = true, description = "The ID of the author (user)")
  ...
  public Note author(User author) {
    this.author = author;
    return this;
  }
  ...
  **/
  ...
  public Note deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public Note metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, note.id) &&
        Objects.equals(this.resourceType, note.resourceType) &&
        Objects.equals(this.resourceId, note.resourceId) &&
        ...
        Objects.equals(this.deletedAt, note.deletedAt) &&
        Objects.equals(this.metadata, note.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, resourceType, resourceId, value, authorId, author, createdAt, updatedAt, deletedAt, metadata);
  }

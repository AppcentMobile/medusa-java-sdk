 ...
 */
@Schema(description = "The Address to add to the Customer.")
...
public class AllOfStorePostCustomersCustomerAddressesReqAddress extends AddressFields {
  ...
  public String toString() {
    ...
    sb.append("class AllOfStorePostCustomersCustomerAddressesReqAddress {\n");

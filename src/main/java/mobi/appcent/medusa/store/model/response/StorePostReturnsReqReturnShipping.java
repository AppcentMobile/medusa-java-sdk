 ...
 */
@Schema(description = "If the Return is to be handled by the store operator the Customer can choose a Return Shipping Method. Alternatvely the Customer can handle the Return themselves.")
...
public class StorePostReturnsReqReturnShipping {
  @SerializedName("option_id")
  private String optionId = null;

  public StorePostReturnsReqReturnShipping optionId(String optionId) {
   ...
   * @return optionId
  **/
  @Schema(required = true, description = "The ID of the Shipping Option to create the Shipping Method from.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostReturnsReqReturnShipping storePostReturnsReqReturnShipping = (StorePostReturnsReqReturnShipping) o;
    return Objects.equals(this.optionId, storePostReturnsReqReturnShipping.optionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostReturnsReqReturnShipping {\n");

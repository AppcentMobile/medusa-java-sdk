 ...
 */
public class AddShippingAddress extends BaseRequest<StoreCustomersRes> {

    private final MedusaSdkClient client;
    private StorePostCustomersCustomerAddressesReq body;

    public AddShippingAddress(MedusaSdkClient client) {
        this.client = client;
    }

    public AddShippingAddress body(StorePostCustomersCustomerAddressesReq body) {
        this.body = body;
        return this;
    }
    ...
    protected Call buildCall() throws ApiException {
        String path = UrlConstant.CUSTOMER_PATH + "/me/addresses";

...
public class Error implements InlineResponse400 {
  @SerializedName("code")
   ...
   * @return code
  **/
  @Schema(description = "A slug code to indicate the type of the error.")
   ...
   * @return message
  **/
  @Schema(description = "Description of the error that occurred.")
   ...
   * @return type
  **/
  @Schema(description = "A slug indicating the type of the error.")

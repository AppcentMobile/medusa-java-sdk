 ...
 */
public class CalculateCartTaxesRequest extends BaseRequest<StoreCartsRes> {

    private final MedusaSdkClient client;
    private final String id;

    public CalculateCartTaxesRequest(MedusaSdkClient client, String id) {
        this.client = client;
        this.id = id;
    }
    ...
    protected Call buildCall() throws ApiException {
        ...
        String path = UrlConstant.CART_PATH + "/" + id + "/taxes";

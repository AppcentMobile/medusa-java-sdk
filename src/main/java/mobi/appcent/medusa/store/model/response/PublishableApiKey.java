 ...
 */
@Schema(description = "Publishable API key defines scopes (i.e. resources) that are available within a request.")
...
public class PublishableApiKey {
  ...
  public PublishableApiKey id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "pk_01G1G5V27GYX4QXNARRQCW1N8T", required = true, description = "The key's ID")
  public String getId() {
    return id;
  }
  ...
  public PublishableApiKey createdBy(String createdBy) {
   ...
   * @return createdBy
  **/
  @Schema(example = "usr_01G1G5V26F5TB3GPAPNJ8X1S3V", required = true, description = "The unique identifier of the user that created the key.")
  ...
  public PublishableApiKey revokedBy(String revokedBy) {
   ...
   * @return revokedBy
  **/
  @Schema(example = "usr_01G1G5V26F5TB3GPAPNJ8X1S3V", required = true, description = "The unique identifier of the user that revoked the key.")
  ...
  public PublishableApiKey revokedAt(OffsetDateTime revokedAt) {
   ...
   * @return revokedAt
  **/
  @Schema(required = true, description = "The date with timezone at which the key was revoked.")
  ...
  public PublishableApiKey title(String title) {
    this.title = title;
    return this;
  }
   ...
   * @return title
  **/
  @Schema(required = true, description = "The key's title.")
  ...
  public PublishableApiKey createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public PublishableApiKey updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PublishableApiKey publishableApiKey = (PublishableApiKey) o;
    return Objects.equals(this.id, publishableApiKey.id) &&
        Objects.equals(this.createdBy, publishableApiKey.createdBy) &&
        Objects.equals(this.revokedBy, publishableApiKey.revokedBy) &&
        Objects.equals(this.revokedAt, publishableApiKey.revokedAt) &&
        Objects.equals(this.title, publishableApiKey.title) &&
        Objects.equals(this.createdAt, publishableApiKey.createdAt) &&
        Objects.equals(this.updatedAt, publishableApiKey.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, createdBy, revokedBy, revokedAt, title, createdAt, updatedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class PublishableApiKey {\n");

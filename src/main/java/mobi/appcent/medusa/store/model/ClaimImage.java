 ...
 */
@Schema(description = "Represents photo documentation of a claim.")
...
public class ClaimImage {
  ...
  @SerializedName("claim_item_id")
  private String claimItemId = null;

  @SerializedName("claim_item")
  private Object claimItem = null;
  ...
  public ClaimImage id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "cimg_01G8ZH853Y6TFXWPG5EYE81X63", required = true, description = "The claim image's ID")
  public String getId() {
    return id;
  }
  ...
  public ClaimImage claimItemId(String claimItemId) {
   ...
   * @return claimItemId
  **/
  @Schema(required = true, description = "The ID of the claim item associated with the image")
  ...
  public ClaimImage claimItem(Object claimItem) {
   ...
   * @return claimItem
  **/
  @Schema(description = "A claim item object. Available if the relation `claim_item` is expanded.")
  public Object getClaimItem() {
    return claimItem;
  }

  public void setClaimItem(Object claimItem) {
    this.claimItem = claimItem;
  }

  public ClaimImage url(String url) {
    this.url = url;
    return this;
  }
   ...
   * @return url
  **/
  @Schema(required = true, description = "The URL of the image")
  ...
  public ClaimImage createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ClaimImage updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ClaimImage deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public ClaimImage metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ClaimImage claimImage = (ClaimImage) o;
    return Objects.equals(this.id, claimImage.id) &&
        Objects.equals(this.claimItemId, claimImage.claimItemId) &&
        Objects.equals(this.claimItem, claimImage.claimItem) &&
        Objects.equals(this.url, claimImage.url) &&
        Objects.equals(this.createdAt, claimImage.createdAt) &&
        Objects.equals(this.updatedAt, claimImage.updatedAt) &&
        Objects.equals(this.deletedAt, claimImage.deletedAt) &&
        Objects.equals(this.metadata, claimImage.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, claimItemId, claimItem, url, createdAt, updatedAt, deletedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClaimImage {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    claimItemId: ").append(toIndentedString(claimItemId)).append("\n");
    sb.append("    claimItem: ").append(toIndentedString(claimItem)).append("\n");

...
/**
 * StorePostSwapsReqAdditionalItems
 */
...
public class StorePostSwapsReqAdditionalItems {
  ...
  public StorePostSwapsReqAdditionalItems variantId(String variantId) {
   ...
   * @return variantId
  **/
  @Schema(required = true, description = "The ID of the Product Variant to send.")
  ...
  public StorePostSwapsReqAdditionalItems quantity(Integer quantity) {
   ...
   * @return quantity
  **/
  @Schema(required = true, description = "The quantity to send of the variant.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostSwapsReqAdditionalItems storePostSwapsReqAdditionalItems = (StorePostSwapsReqAdditionalItems) o;
    return Objects.equals(this.variantId, storePostSwapsReqAdditionalItems.variantId) &&
        Objects.equals(this.quantity, storePostSwapsReqAdditionalItems.quantity);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostSwapsReqAdditionalItems {\n");

...
public class StoreGetAuthEmailRes {
  @SerializedName("exists")
  private Boolean exists = null;

  public StoreGetAuthEmailRes exists(Boolean exists) {
    this.exists = exists;
    return this;
  }
   ...
   * @return exists
  **/
  @Schema(description = "Whether email exists or not.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StoreGetAuthEmailRes storeGetAuthEmailRes = (StoreGetAuthEmailRes) o;
    return Objects.equals(this.exists, storeGetAuthEmailRes.exists);
  }
  ...
  public String toString() {
    ...
    sb.append("class StoreGetAuthEmailRes {\n");

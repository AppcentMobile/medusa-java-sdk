 ...
 */
@Schema(description = "Represents a notification provider plugin and holds its installation status.")
...
public class NotificationProvider {
  ...
  public NotificationProvider id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "sendgrid", required = true, description = "The id of the notification provider as given by the plugin.")
  public String getId() {
    return id;
  }
  ...
  public NotificationProvider isInstalled(Boolean isInstalled) {
   ...
   * @return isInstalled
  **/
  @Schema(required = true, description = "Whether the plugin is installed in the current version. Plugins that are no longer installed are not deleted by will have this field set to `false`.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NotificationProvider notificationProvider = (NotificationProvider) o;
    return Objects.equals(this.id, notificationProvider.id) &&
        Objects.equals(this.isInstalled, notificationProvider.isInstalled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, isInstalled);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationProvider {\n");

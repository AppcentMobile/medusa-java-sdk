...
public class PricedVariant extends ProductVariant {
  @SerializedName("original_price")
  private BigDecimal originalPrice = null;

  @SerializedName("calculated_price")
  private BigDecimal calculatedPrice = null;

  @SerializedName("original_price_incl_tax")
  private BigDecimal originalPriceInclTax = null;

  @SerializedName("calculated_price_incl_tax")
  private BigDecimal calculatedPriceInclTax = null;

  @SerializedName("original_tax")
  private BigDecimal originalTax = null;

  @SerializedName("calculated_tax")
  private BigDecimal calculatedTax = null;

  @SerializedName("tax_rates")
  private List<PricedVariantTaxRates> taxRates = null;

  public PricedVariant originalPrice(BigDecimal originalPrice) {
  ...
  **/
  @Schema(description = "The original price of the variant without any discounted prices applied.")
  ...
  public PricedVariant calculatedPrice(BigDecimal calculatedPrice) {
  ...
  **/
  @Schema(description = "The calculated price of the variant. Can be a discounted price.")
  ...
  public PricedVariant originalPriceInclTax(BigDecimal originalPriceInclTax) {
  ...
  **/
  @Schema(description = "The original price of the variant including taxes.")
  ...
  public PricedVariant calculatedPriceInclTax(BigDecimal calculatedPriceInclTax) {
    this.calculatedPriceInclTax = calculatedPriceInclTax;
    return this;
  }

   /**
   * The calculated price of the variant including taxes.
   * @return calculatedPriceInclTax
  **/
  @Schema(description = "The calculated price of the variant including taxes.")
  public BigDecimal getCalculatedPriceInclTax() {
    return calculatedPriceInclTax;
  }

  public void setCalculatedPriceInclTax(BigDecimal calculatedPriceInclTax) {
    this.calculatedPriceInclTax = calculatedPriceInclTax;
  }

  public PricedVariant originalTax(BigDecimal originalTax) {
   ...
   * @return originalTax
  **/
  @Schema(description = "The taxes applied on the original price.")
  ...
  public PricedVariant calculatedTax(BigDecimal calculatedTax) {
  ...
  **/
  @Schema(description = "The taxes applied on the calculated price.")
  ...
  public PricedVariant taxRates(List<PricedVariantTaxRates> taxRates) {
    this.taxRates = taxRates;
    return this;
  }

  public PricedVariant addTaxRatesItem(PricedVariantTaxRates taxRatesItem) {
    if (this.taxRates == null) {
      this.taxRates = new ArrayList<PricedVariantTaxRates>();
    }
   ...
   * @return taxRates
  **/
  @Schema(description = "An array of applied tax rates")
  public List<PricedVariantTaxRates> getTaxRates() {
    return taxRates;
  }

  public void setTaxRates(List<PricedVariantTaxRates> taxRates) {
    this.taxRates = taxRates;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PricedVariant pricedVariant = (PricedVariant) o;
    return Objects.equals(this.originalPrice, pricedVariant.originalPrice) &&
        Objects.equals(this.calculatedPrice, pricedVariant.calculatedPrice) &&
        Objects.equals(this.originalPriceInclTax, pricedVariant.originalPriceInclTax) &&
        Objects.equals(this.calculatedPriceInclTax, pricedVariant.calculatedPriceInclTax) &&
        Objects.equals(this.originalTax, pricedVariant.originalTax) &&
        Objects.equals(this.calculatedTax, pricedVariant.calculatedTax) &&
        Objects.equals(this.taxRates, pricedVariant.taxRates) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(originalPrice, calculatedPrice, originalPriceInclTax, calculatedPriceInclTax, originalTax, calculatedTax, taxRates, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    calculatedPriceInclTax: ").append(toIndentedString(calculatedPriceInclTax)).append("\n");

...
public class StorePostReturnsReq {
  @SerializedName("order_id")
  private String orderId = null;

  @SerializedName("items")
  private List<StorePostReturnsReqItems> items = new ArrayList<StorePostReturnsReqItems>();

  @SerializedName("return_shipping")
  private StorePostReturnsReqReturnShipping returnShipping = null;

  public StorePostReturnsReq orderId(String orderId) {
   ...
   * @return orderId
  **/
  @Schema(required = true, description = "The ID of the Order to create the Return from.")
  ...
  public StorePostReturnsReq items(List<StorePostReturnsReqItems> items) {
    this.items = items;
    return this;
  }

  public StorePostReturnsReq addItemsItem(StorePostReturnsReqItems itemsItem) {
  ...
  **/
  ...
  public List<StorePostReturnsReqItems> getItems() {
    return items;
  }

  public void setItems(List<StorePostReturnsReqItems> items) {
    this.items = items;
  }

  public StorePostReturnsReq returnShipping(StorePostReturnsReqReturnShipping returnShipping) {
  ...
  **/
  @Schema(description = "")
  public StorePostReturnsReqReturnShipping getReturnShipping() {
    return returnShipping;
  }

  public void setReturnShipping(StorePostReturnsReqReturnShipping returnShipping) {
    this.returnShipping = returnShipping;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostReturnsReq storePostReturnsReq = (StorePostReturnsReq) o;
    return Objects.equals(this.orderId, storePostReturnsReq.orderId) &&
        Objects.equals(this.items, storePostReturnsReq.items) &&
        Objects.equals(this.returnShipping, storePostReturnsReq.returnShipping);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orderId, items, returnShipping);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostReturnsReq {\n");

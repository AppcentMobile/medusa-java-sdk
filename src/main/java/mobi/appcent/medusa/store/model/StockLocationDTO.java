 ...
 */
@Schema(description = "Represents a Stock Location")
...
public class StockLocationDTO {
  ...
  private AllOfStockLocationDTOAddress address = null;
  ...
  public StockLocationDTO id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "sloc_51G4ZW853Y6TFXWPG5ENJ81X42", required = true, description = "The stock location's ID")
  public String getId() {
    return id;
  }
  ...
  public StockLocationDTO addressId(String addressId) {
   ...
   * @return addressId
  **/
  @Schema(example = "laddr_05B2ZE853Y6FTXWPW85NJ81A44", required = true, description = "Stock location address' ID")
  ...
  public StockLocationDTO name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @Schema(example = "Main Warehouse", required = true, description = "The name of the stock location")
  ...
  public StockLocationDTO address(AllOfStockLocationDTOAddress address) {
   ...
   * @return address
  **/
  @Schema(description = "The Address of the Stock Location")
  public AllOfStockLocationDTOAddress getAddress() {
    return address;
  }

  public void setAddress(AllOfStockLocationDTOAddress address) {
    this.address = address;
  }

  public StockLocationDTO metadata(Object metadata) {
  ...
  **/
  ...
  public StockLocationDTO createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public StockLocationDTO updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public StockLocationDTO deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, stockLocationDTO.id) &&
        Objects.equals(this.addressId, stockLocationDTO.addressId) &&
        Objects.equals(this.name, stockLocationDTO.name) &&
        Objects.equals(this.address, stockLocationDTO.address) &&
        Objects.equals(this.metadata, stockLocationDTO.metadata) &&
        Objects.equals(this.createdAt, stockLocationDTO.createdAt) &&
        Objects.equals(this.updatedAt, stockLocationDTO.updatedAt) &&
        Objects.equals(this.deletedAt, stockLocationDTO.deletedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, addressId, name, address, metadata, createdAt, updatedAt, deletedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class StockLocationDTO {\n");

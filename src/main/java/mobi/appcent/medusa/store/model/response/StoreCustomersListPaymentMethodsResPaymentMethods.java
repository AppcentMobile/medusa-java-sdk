...
/**
 * StoreCustomersListPaymentMethodsResPaymentMethods
 */
...
public class StoreCustomersListPaymentMethodsResPaymentMethods {
  ...
  public StoreCustomersListPaymentMethodsResPaymentMethods providerId(String providerId) {
   ...
   * @return providerId
  **/
  @Schema(description = "The id of the Payment Provider where the payment method is saved.")
  ...
  public StoreCustomersListPaymentMethodsResPaymentMethods data(Object data) {
    this.data = data;
    return this;
  }
   ...
   * @return data
  **/
  @Schema(description = "The data needed for the Payment Provider to use the saved payment method.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StoreCustomersListPaymentMethodsResPaymentMethods storeCustomersListPaymentMethodsResPaymentMethods = (StoreCustomersListPaymentMethodsResPaymentMethods) o;
    return Objects.equals(this.providerId, storeCustomersListPaymentMethodsResPaymentMethods.providerId) &&
        Objects.equals(this.data, storeCustomersListPaymentMethodsResPaymentMethods.data);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerId, data);
  }
  ...
  public String toString() {
    ...
    sb.append("class StoreCustomersListPaymentMethodsResPaymentMethods {\n");

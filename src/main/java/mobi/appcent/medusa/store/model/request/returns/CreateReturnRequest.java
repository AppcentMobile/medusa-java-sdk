package mobi.appcent.medusa.store.model.request.returns;
 ...
 */
public class CreateReturnRequest extends BaseRequest<StoreReturnsRes> {

    private final MedusaSdkClient client;
    private StorePostReturnsReq body;

    public CreateReturnRequest(MedusaSdkClient client) {
        this.client = client;
    }

    public CreateReturnRequest body(StorePostReturnsReq body) {
        this.body = body;
        return this;
    }
    ...
    protected Call buildCall() throws ApiException {
        String path = UrlConstant.RETURN_PATH;
    ...
    @Override
    public ApiResponse<StoreReturnsRes> execute() throws ApiException {
        Call call = buildCall();
        return client.execute(call, getType());
    }

    @Override
    public void executeAsync(ApiCallback<StoreReturnsRes> callback) throws ApiException {
        Call call = buildCall();
    ...
    @Override
    public Type getType() {
        return new TypeToken<StoreReturnsRes>(){}.getType();
    }
}

 ...
 */
@Schema(description = "A Reason for why a given product is returned. A Return Reason can be used on Return Items in order to indicate why a Line Item was returned.")
...
public class ReturnReason {
  ...
  @SerializedName("parent_return_reason_id")
  private String parentReturnReasonId = null;

  @SerializedName("parent_return_reason")
  private Object parentReturnReason = null;

  @SerializedName("return_reason_children")
  private Object returnReasonChildren = null;
  ...
  public ReturnReason id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "rr_01G8X82GCCV2KSQHDBHSSAH5TQ", required = true, description = "The return reason's ID")
  public String getId() {
    return id;
  }
  ...
  public ReturnReason value(String value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @Schema(example = "damaged", required = true, description = "The value to identify the reason by.")
  ...
  public ReturnReason label(String label) {
    this.label = label;
    return this;
  }
   ...
   * @return label
  **/
  @Schema(example = "Damaged goods", required = true, description = "A text that can be displayed to the Customer as a reason.")
  ...
  public ReturnReason description(String description) {
   ...
   * @return description
  **/
  @Schema(example = "Items that are damaged", required = true, description = "A description of the Reason.")
  ...
  public ReturnReason parentReturnReasonId(String parentReturnReasonId) {
   ...
   * @return parentReturnReasonId
  **/
  @Schema(required = true, description = "The ID of the parent reason.")
  public String getParentReturnReasonId() {
    return parentReturnReasonId;
  }

  public void setParentReturnReasonId(String parentReturnReasonId) {
    this.parentReturnReasonId = parentReturnReasonId;
  }

  public ReturnReason parentReturnReason(Object parentReturnReason) {
   ...
   * @return parentReturnReason
  **/
  @Schema(description = "Available if the relation `parent_return_reason` is expanded.")
  public Object getParentReturnReason() {
    return parentReturnReason;
  }

  public void setParentReturnReason(Object parentReturnReason) {
    this.parentReturnReason = parentReturnReason;
  }

  public ReturnReason returnReasonChildren(Object returnReasonChildren) {
   ...
   * @return returnReasonChildren
  **/
  @Schema(description = "Available if the relation `return_reason_children` is expanded.")
  public Object getReturnReasonChildren() {
    return returnReasonChildren;
  }

  public void setReturnReasonChildren(Object returnReasonChildren) {
    this.returnReasonChildren = returnReasonChildren;
  }

  public ReturnReason createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ReturnReason updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ReturnReason deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public ReturnReason metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, returnReason.id) &&
        Objects.equals(this.value, returnReason.value) &&
        Objects.equals(this.label, returnReason.label) &&
        Objects.equals(this.description, returnReason.description) &&
        Objects.equals(this.parentReturnReasonId, returnReason.parentReturnReasonId) &&
        Objects.equals(this.parentReturnReason, returnReason.parentReturnReason) &&
        Objects.equals(this.returnReasonChildren, returnReason.returnReasonChildren) &&
        Objects.equals(this.createdAt, returnReason.createdAt) &&
        Objects.equals(this.updatedAt, returnReason.updatedAt) &&
        Objects.equals(this.deletedAt, returnReason.deletedAt) &&
        Objects.equals(this.metadata, returnReason.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, value, label, description, parentReturnReasonId, parentReturnReason, returnReasonChildren, createdAt, updatedAt, deletedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("    parentReturnReasonId: ").append(toIndentedString(parentReturnReasonId)).append("\n");
    sb.append("    parentReturnReason: ").append(toIndentedString(parentReturnReason)).append("\n");
    sb.append("    returnReasonChildren: ").append(toIndentedString(returnReasonChildren)).append("\n");

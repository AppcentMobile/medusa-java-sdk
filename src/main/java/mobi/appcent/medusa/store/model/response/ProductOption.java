 ...
 */
@Schema(description = "Product Options define properties that may vary between different variants of a Product. Common Product Options are \"Size\" and \"Color\", but Medusa doesn't limit what Product Options that can be defined.")
...
public class ProductOption {
  ...
  private List<ProductOptionValue> values = null;
   ...
   * @return id
  **/
  @Schema(example = "opt_01F0YESHQBZVKCEXJ24BS6PCX3", required = true, description = "The product option's ID")
  public String getId() {
    return id;
  }
  ...
  public ProductOption title(String title) {
    this.title = title;
    return this;
  }
   ...
   * @return title
  **/
  @Schema(example = "Size", required = true, description = "The title that the Product Option is defined by (e.g. `Size`).")
  ...
  public ProductOption values(List<ProductOptionValue> values) {
    this.values = values;
    return this;
  }

  public ProductOption addValuesItem(ProductOptionValue valuesItem) {
    if (this.values == null) {
      this.values = new ArrayList<ProductOptionValue>();
    }
   ...
   * @return values
  **/
  @Schema(description = "The Product Option Values that are defined for the Product Option. Available if the relation `values` is expanded.")
  ...
  public ProductOption productId(String productId) {
   ...
   * @return productId
  **/
  @Schema(example = "prod_01G1G5V2MBA328390B5AXJ610F", required = true, description = "The ID of the Product that the Product Option is defined for.")
  ...
  public ProductOption product(Object product) {
  ...
  **/
  ...
  public ProductOption createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ProductOption updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ProductOption deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public ProductOption metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, productOption.id) &&
        Objects.equals(this.title, productOption.title) &&
        Objects.equals(this.values, productOption.values) &&
        Objects.equals(this.productId, productOption.productId) &&
        Objects.equals(this.product, productOption.product) &&
        Objects.equals(this.createdAt, productOption.createdAt) &&
        Objects.equals(this.updatedAt, productOption.updatedAt) &&
        Objects.equals(this.deletedAt, productOption.deletedAt) &&
        Objects.equals(this.metadata, productOption.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, title, values, productId, product, createdAt, updatedAt, deletedAt, metadata);
  }

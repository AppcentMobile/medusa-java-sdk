...
public class StorePostCustomersResetPasswordReq {
  ...
  public StorePostCustomersResetPasswordReq email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public StorePostCustomersResetPasswordReq password(String password) {
  ...
  **/
  ...
  public StorePostCustomersResetPasswordReq token(String token) {
    this.token = token;
    return this;
  }
   ...
   * @return token
  **/
  @Schema(required = true, description = "The reset password token")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostCustomersResetPasswordReq storePostCustomersResetPasswordReq = (StorePostCustomersResetPasswordReq) o;
    return Objects.equals(this.email, storePostCustomersResetPasswordReq.email) &&
        Objects.equals(this.password, storePostCustomersResetPasswordReq.password) &&
        Objects.equals(this.token, storePostCustomersResetPasswordReq.token);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostCustomersResetPasswordReq {\n");

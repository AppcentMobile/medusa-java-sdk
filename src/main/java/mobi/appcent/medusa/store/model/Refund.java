 ...
 */
@Schema(description = "Refund represent an amount of money transfered back to the Customer for a given reason. Refunds may occur in relation to Returns, Swaps and Claims, but can also be initiated by a store operator.")
...
public class Refund {
   ...
   * @return id
  **/
  @Schema(example = "ref_01G1G5V27GYX4QXNARRQCW1N8T", required = true, description = "The refund's ID")
  public String getId() {
    return id;
  }
   ...
   * @return orderId
  **/
  @Schema(example = "order_01G8TJSYT9M6AVS5N4EMNFS1EK", required = true, description = "The id of the Order that the Refund is related to.")
  ...
  public Refund order(Object order) {
    this.order = order;
    return this;
  }
  ...
  **/
  ...
  public Refund payment(Object payment) {
  ...
  **/
   ...
   * @return amount
  **/
  @Schema(example = "1000", required = true, description = "The amount that has be refunded to the Customer.")
   ...
   * @return note
  **/
  @Schema(example = "I didn't like it", required = true, description = "An optional note explaining why the amount was refunded.")
   ...
   * @return reason
  **/
  @Schema(example = "return", required = true, description = "The reason given for the Refund, will automatically be set when processed as part of a Swap, Claim or Return.")
  ...
  public Refund idempotencyKey(String idempotencyKey) {
  ...
  **/
  @Schema(required = true, description = "Randomly generated key used to continue the completion of the refund in case of failure.")
  ...
  **/
  ...
  public Refund metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, refund.id) &&
        ...
        Objects.equals(this.order, refund.order) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, orderId, order, paymentId, payment, amount, note, reason, idempotencyKey, createdAt, updatedAt, metadata);
  }

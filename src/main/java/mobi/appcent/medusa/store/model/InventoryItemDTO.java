...
public class InventoryItemDTO {
  ...
  private Boolean requiresShipping = null;
  ...
  public InventoryItemDTO sku(String sku) {
    this.sku = sku;
    return this;
  }
   ...
   * @return sku
  **/
  @Schema(required = true, description = "The Stock Keeping Unit (SKU) code of the Inventory Item.")
  ...
  public InventoryItemDTO hsCode(String hsCode) {
    this.hsCode = hsCode;
    return this;
  }
   ...
   * @return hsCode
  **/
  @Schema(description = "The Harmonized System code of the Inventory Item. May be used by Fulfillment Providers to pass customs information to shipping carriers.")
  ...
  public InventoryItemDTO originCountry(String originCountry) {
  ...
  **/
  @Schema(description = "The country in which the Inventory Item was produced. May be used by Fulfillment Providers to pass customs information to shipping carriers.")
  ...
  public InventoryItemDTO midCode(String midCode) {
   ...
   * @return midCode
  **/
  @Schema(description = "The Manufacturers Identification code that identifies the manufacturer of the Inventory Item. May be used by Fulfillment Providers to pass customs information to shipping carriers.")
  ...
  public InventoryItemDTO material(String material) {
   ...
   * @return material
  **/
  @Schema(description = "The material and composition that the Inventory Item is made of, May be used by Fulfillment Providers to pass customs information to shipping carriers.")
  ...
  public InventoryItemDTO weight(BigDecimal weight) {
    this.weight = weight;
    return this;
  }
   ...
   * @return weight
  **/
  @Schema(description = "The weight of the Inventory Item. May be used in shipping rate calculations.")
  ...
  public InventoryItemDTO height(BigDecimal height) {
    this.height = height;
    return this;
  }
   ...
   * @return height
  **/
  @Schema(description = "The height of the Inventory Item. May be used in shipping rate calculations.")
  ...
  public InventoryItemDTO width(BigDecimal width) {
    this.width = width;
    return this;
  }
   ...
   * @return width
  **/
  @Schema(description = "The width of the Inventory Item. May be used in shipping rate calculations.")
  ...
  public InventoryItemDTO length(BigDecimal length) {
    this.length = length;
    return this;
  }
   ...
   * @return length
  **/
  @Schema(description = "The length of the Inventory Item. May be used in shipping rate calculations.")
  ...
  public InventoryItemDTO requiresShipping(Boolean requiresShipping) {
  ...
  **/
  @Schema(description = "Whether the item requires shipping.")
  ...
  public InventoryItemDTO metadata(Object metadata) {
  ...
  **/
  ...
  public InventoryItemDTO createdAt(OffsetDateTime createdAt) {
   ...
   * @return createdAt
  **/
  @Schema(description = "The date with timezone at which the resource was created.")
  ...
  public InventoryItemDTO updatedAt(OffsetDateTime updatedAt) {
   ...
   * @return updatedAt
  **/
  @Schema(description = "The date with timezone at which the resource was updated.")
  ...
  public InventoryItemDTO deletedAt(OffsetDateTime deletedAt) {
   ...
   * @return deletedAt
  **/
  @Schema(description = "The date with timezone at which the resource was deleted.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sku, inventoryItemDTO.sku) &&
        Objects.equals(this.hsCode, inventoryItemDTO.hsCode) &&
        Objects.equals(this.originCountry, inventoryItemDTO.originCountry) &&
        Objects.equals(this.midCode, inventoryItemDTO.midCode) &&
        Objects.equals(this.material, inventoryItemDTO.material) &&
        Objects.equals(this.weight, inventoryItemDTO.weight) &&
        Objects.equals(this.height, inventoryItemDTO.height) &&
        Objects.equals(this.width, inventoryItemDTO.width) &&
        Objects.equals(this.length, inventoryItemDTO.length) &&
        Objects.equals(this.requiresShipping, inventoryItemDTO.requiresShipping) &&
        Objects.equals(this.metadata, inventoryItemDTO.metadata) &&
        Objects.equals(this.createdAt, inventoryItemDTO.createdAt) &&
        Objects.equals(this.updatedAt, inventoryItemDTO.updatedAt) &&
        Objects.equals(this.deletedAt, inventoryItemDTO.deletedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sku, hsCode, originCountry, midCode, material, weight, height, width, length, requiresShipping, metadata, createdAt, updatedAt, deletedAt);
  }

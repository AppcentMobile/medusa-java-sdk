 ...
 */
public class AddLineItemRequest extends BaseRequest<StoreCartsRes> {

    private final MedusaSdkClient client;
    private final String id;
    private StorePostCartsCartLineItemsReq body;

    public AddLineItemRequest(MedusaSdkClient client, String id) {
        this.client = client;
        this.id = id;
    }

    public AddLineItemRequest body(StorePostCartsCartLineItemsReq body) {
        this.body = body;
        return this;
    }
    ...
    protected Call buildCall() throws ApiException {
        ...
        String path = UrlConstant.CART_PATH + "/" + id + "/line-items";

 ...
 */
@Schema(description = "Line item that specifies an amount of tax to add to a line item.")
...
public class TaxLine {
   ...
   * @return id
  **/
  @Schema(example = "tl_01G1G5V2DRX1SK6NQQ8VVX4HQ8", required = true, description = "The tax line's ID")
  public String getId() {
    return id;
  }
  ...
  public TaxLine code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public TaxLine name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public TaxLine createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public TaxLine updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public TaxLine metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, taxLine.id) &&
        Objects.equals(this.code, taxLine.code) &&
        Objects.equals(this.name, taxLine.name) &&
        Objects.equals(this.rate, taxLine.rate) &&
        Objects.equals(this.createdAt, taxLine.createdAt) &&
        Objects.equals(this.updatedAt, taxLine.updatedAt) &&
        Objects.equals(this.metadata, taxLine.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, code, name, rate, createdAt, updatedAt, metadata);
  }

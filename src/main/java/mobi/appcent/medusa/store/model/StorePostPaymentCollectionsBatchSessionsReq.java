...
public class StorePostPaymentCollectionsBatchSessionsReq {
  @SerializedName("sessions")
  private List<StorePostPaymentCollectionsBatchSessionsReqSessions> sessions = new ArrayList<StorePostPaymentCollectionsBatchSessionsReqSessions>();

  public StorePostPaymentCollectionsBatchSessionsReq sessions(List<StorePostPaymentCollectionsBatchSessionsReqSessions> sessions) {
    this.sessions = sessions;
    return this;
  }

  public StorePostPaymentCollectionsBatchSessionsReq addSessionsItem(StorePostPaymentCollectionsBatchSessionsReqSessions sessionsItem) {
   ...
   * @return sessions
  **/
  @Schema(required = true, description = "An array of payment sessions related to the Payment Collection. If the session_id is not provided, existing sessions not present will be deleted and the provided ones will be created.")
  public List<StorePostPaymentCollectionsBatchSessionsReqSessions> getSessions() {
    return sessions;
  }

  public void setSessions(List<StorePostPaymentCollectionsBatchSessionsReqSessions> sessions) {
    this.sessions = sessions;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostPaymentCollectionsBatchSessionsReq storePostPaymentCollectionsBatchSessionsReq = (StorePostPaymentCollectionsBatchSessionsReq) o;
    return Objects.equals(this.sessions, storePostPaymentCollectionsBatchSessionsReq.sessions);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostPaymentCollectionsBatchSessionsReq {\n");

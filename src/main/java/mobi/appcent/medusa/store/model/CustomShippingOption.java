 ...
 */
@Schema(description = "Custom Shipping Options are 'overriden' Shipping Options. Store managers can attach a Custom Shipping Option to a cart in order to set a custom price for a particular Shipping Option")
...
public class CustomShippingOption {
  @SerializedName("id")
  ...
  public CustomShippingOption id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "cso_01G8X99XNB77DMFBJFWX6DN9V9", required = true, description = "The custom shipping option's ID")
  public String getId() {
    return id;
  }
  ...
  public CustomShippingOption price(Integer price) {
    this.price = price;
    return this;
  }
   ...
   * @return price
  **/
  @Schema(example = "1000", required = true, description = "The custom price set that will override the shipping option's original price")
  ...
  public CustomShippingOption shippingOptionId(String shippingOptionId) {
  ...
  **/
  @Schema(example = "so_01G1G5V27GYX4QXNARRQCW1N8T", required = true, description = "The ID of the Shipping Option that the custom shipping option overrides")
  ...
  public CustomShippingOption shippingOption(ShippingOption shippingOption) {
  ...
  **/
  ...
  public CustomShippingOption cartId(String cartId) {
    this.cartId = cartId;
    return this;
  }
   ...
   * @return cartId
  **/
  @Schema(example = "cart_01G8ZH853Y6TFXWPG5EYE81X63", required = true, description = "The ID of the Cart that the custom shipping option is attached to")
  ...
  public CustomShippingOption cart(Cart cart) {
    this.cart = cart;
    return this;
  }
  ...
  **/
  ...
  public CustomShippingOption createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public CustomShippingOption updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public CustomShippingOption deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public CustomShippingOption metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CustomShippingOption customShippingOption = (CustomShippingOption) o;
    return Objects.equals(this.id, customShippingOption.id) &&
        Objects.equals(this.price, customShippingOption.price) &&
        Objects.equals(this.shippingOptionId, customShippingOption.shippingOptionId) &&
        Objects.equals(this.shippingOption, customShippingOption.shippingOption) &&
        Objects.equals(this.cartId, customShippingOption.cartId) &&
        Objects.equals(this.cart, customShippingOption.cart) &&
        Objects.equals(this.createdAt, customShippingOption.createdAt) &&
        Objects.equals(this.updatedAt, customShippingOption.updatedAt) &&
        Objects.equals(this.deletedAt, customShippingOption.deletedAt) &&
        Objects.equals(this.metadata, customShippingOption.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, price, shippingOptionId, shippingOption, cartId, cart, createdAt, updatedAt, deletedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomShippingOption {\n");

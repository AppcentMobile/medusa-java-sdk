...
public class StorePostCartsCartPaymentSessionUpdateReq {
  @SerializedName("data")
  private Object data = null;

  public StorePostCartsCartPaymentSessionUpdateReq data(Object data) {
    this.data = data;
    return this;
  }
   ...
   * @return data
  **/
  @Schema(required = true, description = "The data to update the payment session with.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostCartsCartPaymentSessionUpdateReq storePostCartsCartPaymentSessionUpdateReq = (StorePostCartsCartPaymentSessionUpdateReq) o;
    return Objects.equals(this.data, storePostCartsCartPaymentSessionUpdateReq.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostCartsCartPaymentSessionUpdateReq {\n");

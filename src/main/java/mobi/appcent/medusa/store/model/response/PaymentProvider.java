 ...
 */
@Schema(description = "Represents a Payment Provider plugin and holds its installation status.")
...
public class PaymentProvider {
   ...
   * @return id
  **/
  @Schema(example = "manual", required = true, description = "The id of the payment provider as given by the plugin.")
  public String getId() {
    return id;
  }
  ...
  public PaymentProvider isInstalled(Boolean isInstalled) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, paymentProvider.id) &&
        Objects.equals(this.isInstalled, paymentProvider.isInstalled);
  }

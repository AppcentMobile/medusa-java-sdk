 ...
 */
@Schema(description = "Represent an OAuth app")
...
public class OAuth {
  ...
  @SerializedName("uninstall_url")
  private String uninstallUrl = null;

  @SerializedName("data")
  private Object data = null;

  public OAuth id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "example_app", required = true, description = "The app's ID")
  public String getId() {
    return id;
  }
  ...
  public OAuth displayName(String displayName) {
   ...
   * @return displayName
  **/
  @Schema(example = "Example app", required = true, description = "The app's display name")
  ...
  public OAuth applicationName(String applicationName) {
  ...
  **/
  @Schema(example = "example", required = true, description = "The app's name")
  ...
  public OAuth installUrl(String installUrl) {
   ...
   * @return installUrl
  **/
  @Schema(required = true, description = "The URL to install the app")
  ...
  public OAuth uninstallUrl(String uninstallUrl) {
   ...
   * @return uninstallUrl
  **/
  @Schema(required = true, description = "The URL to uninstall the app")
   ...
   * @return data
  **/
  @Schema(example = "{}", required = true, description = "Any data necessary to the app.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OAuth oauth = (OAuth) o;
    return Objects.equals(this.id, oauth.id) &&
        Objects.equals(this.displayName, oauth.displayName) &&
        Objects.equals(this.applicationName, oauth.applicationName) &&
        Objects.equals(this.installUrl, oauth.installUrl) &&
        Objects.equals(this.uninstallUrl, oauth.uninstallUrl) &&
        Objects.equals(this.data, oauth.data);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, displayName, applicationName, installUrl, uninstallUrl, data);
  }
  ...
  public String toString() {
    ...
    sb.append("    uninstallUrl: ").append(toIndentedString(uninstallUrl)).append("\n");

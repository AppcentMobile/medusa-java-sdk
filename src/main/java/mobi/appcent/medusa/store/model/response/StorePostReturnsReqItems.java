...
public class StorePostReturnsReqItems {
  ...
  public StorePostReturnsReqItems itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  **/
  ...
  public StorePostReturnsReqItems quantity(Integer quantity) {
   ...
   * @return quantity
  **/
  @Schema(required = true, description = "The quantity to return.")
  ...
  public StorePostReturnsReqItems reasonId(String reasonId) {
   ...
   * @return reasonId
  **/
  @Schema(description = "The ID of the return reason.")
  ...
  public StorePostReturnsReqItems note(String note) {
    this.note = note;
    return this;
  }
   ...
   * @return note
  **/
  @Schema(description = "A note to add to the item returned.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostReturnsReqItems storePostReturnsReqItems = (StorePostReturnsReqItems) o;
    return Objects.equals(this.itemId, storePostReturnsReqItems.itemId) &&
        Objects.equals(this.quantity, storePostReturnsReqItems.quantity) &&
        Objects.equals(this.reasonId, storePostReturnsReqItems.reasonId) &&
        Objects.equals(this.note, storePostReturnsReqItems.note);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostReturnsReqItems {\n");

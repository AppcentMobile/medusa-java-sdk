...
public class Currency {
  ...
  private String symbolNative = null;
  ...
  **/
   ...
   * @return symbol
  **/
  @Schema(example = "$", required = true, description = "The symbol used to indicate the currency.")
   ...
   * @return symbolNative
  **/
  @Schema(example = "$", required = true, description = "The native symbol used to indicate the currency.")
   ...
   * @return name
  **/
  @Schema(example = "US Dollar", required = true, description = "The written name of the currency")
  ...
  public Currency includesTax(Boolean includesTax) {
   ...
   * @return includesTax
  **/
  @Schema(description = "[EXPERIMENTAL] Does the currency prices include tax")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.code, currency.code) &&
        ...
        Objects.equals(this.includesTax, currency.includesTax);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, symbol, symbolNative, name, includesTax);
  }

 ...
 */
@Schema(description = "Price Lists represents a set of prices that overrides the default price for one or more product variants.")
...
public class PriceList {
  ...
  private TypeEnum type = TypeEnum.SALE;
   ...
   * @return id
  **/
  @Schema(example = "pl_01G8X3CKJXCG5VXVZ87H9KC09W", required = true, description = "The price list's ID")
  public String getId() {
    return id;
  }
   ...
   * @return name
  **/
  @Schema(example = "VIP Prices", required = true, description = "The price list's name")
   ...
   * @return description
  **/
  @Schema(example = "Prices for VIP customers", required = true, description = "The price list's description")
  ...
  public PriceList type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @Schema(required = true, description = "The type of Price List. This can be one of either `sale` or `override`.")
  ...
  public PriceList status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @Schema(required = true, description = "The status of the Price List")
  ...
  public PriceList startsAt(OffsetDateTime startsAt) {
   ...
   * @return startsAt
  **/
  @Schema(required = true, description = "The date with timezone that the Price List starts being valid.")
  ...
  public PriceList endsAt(OffsetDateTime endsAt) {
    this.endsAt = endsAt;
    return this;
  }
   ...
   * @return endsAt
  **/
  @Schema(required = true, description = "The date with timezone that the Price List stops being valid.")
  ...
  public PriceList customerGroups(List<CustomerGroup> customerGroups) {
    this.customerGroups = customerGroups;
    return this;
  }

  public PriceList addCustomerGroupsItem(CustomerGroup customerGroupsItem) {
  ...
  **/
  @Schema(description = "The Customer Groups that the Price List applies to. Available if the relation `customer_groups` is expanded.")
  ...
  public PriceList prices(List<MoneyAmount> prices) {
    this.prices = prices;
    return this;
  }

  public PriceList addPricesItem(MoneyAmount pricesItem) {
    if (this.prices == null) {
   ...
   * @return prices
  **/
  @Schema(description = "The Money Amounts that are associated with the Price List. Available if the relation `prices` is expanded.")
  ...
  public PriceList includesTax(Boolean includesTax) {
   ...
   * @return includesTax
  **/
  @Schema(description = "[EXPERIMENTAL] Does the price list prices include tax")
  ...
  public PriceList createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public PriceList updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public PriceList deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, priceList.id) &&
        ...
        Objects.equals(this.status, priceList.status) &&
        Objects.equals(this.startsAt, priceList.startsAt) &&
        Objects.equals(this.endsAt, priceList.endsAt) &&
        Objects.equals(this.customerGroups, priceList.customerGroups) &&
        Objects.equals(this.prices, priceList.prices) &&
        Objects.equals(this.includesTax, priceList.includesTax) &&
        Objects.equals(this.createdAt, priceList.createdAt) &&
        Objects.equals(this.updatedAt, priceList.updatedAt) &&
        Objects.equals(this.deletedAt, priceList.deletedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, type, status, startsAt, endsAt, customerGroups, prices, includesTax, createdAt, updatedAt, deletedAt);
  }

 ...
 */
@Schema(description = "Images holds a reference to a URL at which the image file can be found.")
...
public class Image {
   ...
   * @return id
  **/
  @Schema(example = "img_01G749BFYR6T8JTVW6SGW3K3E6", required = true, description = "The image's ID")
  public String getId() {
    return id;
  }
   ...
   * @return url
  **/
  @Schema(required = true, description = "The URL at which the image file can be found.")
  ...
  **/
  ...
  public Image updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public Image metadata(Object metadata) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, url, createdAt, updatedAt, deletedAt, metadata);
  }

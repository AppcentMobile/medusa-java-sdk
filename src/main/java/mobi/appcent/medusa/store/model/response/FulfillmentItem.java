 ...
 */
@Schema(description = "Correlates a Line Item with a Fulfillment, keeping track of the quantity of the Line Item.")
...
public class FulfillmentItem {
  ...
  public FulfillmentItem fulfillmentId(String fulfillmentId) {
  ...
  **/
  @Schema(example = "ful_01G8ZRTMQCA76TXNAT81KPJZRF", required = true, description = "The id of the Fulfillment that the Fulfillment Item belongs to.")
  ...
  public FulfillmentItem itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
   ...
   * @return itemId
  **/
  @Schema(example = "item_01G8ZC9GWT6B2GP5FSXRXNFNGN", required = true, description = "The id of the Line Item that the Fulfillment Item references.")
  ...
  public FulfillmentItem fulfillment(Object fulfillment) {
   ...
   * @return fulfillment
  **/
  @Schema(description = "A fulfillment object. Available if the relation `fulfillment` is expanded.")
  ...
  public FulfillmentItem item(LineItem item) {
    this.item = item;
    return this;
  }
  ...
  **/
   ...
   * @return quantity
  **/
  @Schema(example = "1", required = true, description = "The quantity of the Line Item that is included in the Fulfillment.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.fulfillmentId, fulfillmentItem.fulfillmentId) &&
        Objects.equals(this.itemId, fulfillmentItem.itemId) &&
        Objects.equals(this.fulfillment, fulfillmentItem.fulfillment) &&
        Objects.equals(this.item, fulfillmentItem.item) &&
        Objects.equals(this.quantity, fulfillmentItem.quantity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fulfillmentId, itemId, fulfillment, item, quantity);
  }

 ...
 */
public class GetRegionRequest extends BaseRequest<StoreRegionsRes> {

    private final MedusaSdkClient client;
    private final String id;

    public GetRegionRequest(MedusaSdkClient client, String id) {
        this.client = client;
        this.id = id;
    }
    ...
    protected Call buildCall() throws ApiException {
        String path = UrlConstant.REGION_PATH + "/" + id;
    ...
    @Override
    public ApiResponse<StoreRegionsRes> execute() throws ApiException {
        Call call = buildCall();
        return client.execute(call, getType());
    }

    @Override
    public void executeAsync(ApiCallback<StoreRegionsRes> callback) throws ApiException {
        Call call = buildCall();
    ...
    @Override
    public Type getType() {
        return new TypeToken<StoreRegionsRes>(){}.getType();
    }
}

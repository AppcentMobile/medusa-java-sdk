...
public class StorePostCustomersCustomerOrderClaimReq {
  @SerializedName("order_ids")
  private List<String> orderIds = new ArrayList<String>();

  public StorePostCustomersCustomerOrderClaimReq orderIds(List<String> orderIds) {
    this.orderIds = orderIds;
    return this;
  }

  public StorePostCustomersCustomerOrderClaimReq addOrderIdsItem(String orderIdsItem) {
   ...
   * @return orderIds
  **/
  @Schema(required = true, description = "The ids of the orders to claim")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostCustomersCustomerOrderClaimReq storePostCustomersCustomerOrderClaimReq = (StorePostCustomersCustomerOrderClaimReq) o;
    return Objects.equals(this.orderIds, storePostCustomersCustomerOrderClaimReq.orderIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostCustomersCustomerOrderClaimReq {\n");

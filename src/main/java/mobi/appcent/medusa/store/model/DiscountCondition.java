 ...
 */
@Schema(description = "Holds rule conditions for when a discount is applicable")
...
public class DiscountCondition {
  ...
  private String discountRuleId = null;
  ...
  @SerializedName("product_collections")
  private List<ProductCollection> productCollections = null;
  ...
  public DiscountCondition id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "discon_01G8X9A7ESKAJXG2H0E6F1MW7A", required = true, description = "The discount condition's ID")
  public String getId() {
    return id;
  }
  ...
  public DiscountCondition type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @Schema(required = true, description = "The type of the Condition")
  ...
  public DiscountCondition operator(OperatorEnum operator) {
   ...
   * @return operator
  **/
  @Schema(required = true, description = "The operator of the Condition")
  ...
  public DiscountCondition discountRuleId(String discountRuleId) {
  ...
  **/
  @Schema(example = "dru_01F0YESMVK96HVX7N419E3CJ7C", required = true, description = "The ID of the discount rule associated with the condition")
  ...
  public DiscountCondition discountRule(DiscountRule discountRule) {
  ...
  **/
  ...
  public DiscountCondition products(List<Product> products) {
    this.products = products;
    return this;
  }

  public DiscountCondition addProductsItem(Product productsItem) {
   ...
   * @return products
  **/
  @Schema(description = "products associated with this condition if type = products. Available if the relation `products` is expanded.")
  ...
  public DiscountCondition productTypes(List<ProductType> productTypes) {
    this.productTypes = productTypes;
    return this;
  }

  public DiscountCondition addProductTypesItem(ProductType productTypesItem) {
   ...
   * @return productTypes
  **/
  @Schema(description = "Product types associated with this condition if type = product_types. Available if the relation `product_types` is expanded.")
  ...
  public DiscountCondition productTags(List<ProductTag> productTags) {
    this.productTags = productTags;
    return this;
  }

  public DiscountCondition addProductTagsItem(ProductTag productTagsItem) {
   ...
   * @return productTags
  **/
  @Schema(description = "Product tags associated with this condition if type = product_tags. Available if the relation `product_tags` is expanded.")
  ...
  public DiscountCondition productCollections(List<ProductCollection> productCollections) {
    this.productCollections = productCollections;
    return this;
  }

  public DiscountCondition addProductCollectionsItem(ProductCollection productCollectionsItem) {
    if (this.productCollections == null) {
      this.productCollections = new ArrayList<ProductCollection>();
    }
  ...
  **/
  @Schema(description = "Product collections associated with this condition if type = product_collections. Available if the relation `product_collections` is expanded.")
  ...
  public DiscountCondition customerGroups(List<CustomerGroup> customerGroups) {
    this.customerGroups = customerGroups;
    return this;
  }

  public DiscountCondition addCustomerGroupsItem(CustomerGroup customerGroupsItem) {
    if (this.customerGroups == null) {
      this.customerGroups = new ArrayList<CustomerGroup>();
    }
  ...
  **/
  @Schema(description = "Customer groups associated with this condition if type = customer_groups. Available if the relation `customer_groups` is expanded.")
  ...
  public DiscountCondition createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public DiscountCondition updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public DiscountCondition deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public DiscountCondition metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DiscountCondition discountCondition = (DiscountCondition) o;
    return Objects.equals(this.id, discountCondition.id) &&
        Objects.equals(this.type, discountCondition.type) &&
        Objects.equals(this.operator, discountCondition.operator) &&
        Objects.equals(this.discountRuleId, discountCondition.discountRuleId) &&
        Objects.equals(this.discountRule, discountCondition.discountRule) &&
        Objects.equals(this.products, discountCondition.products) &&
        Objects.equals(this.productTypes, discountCondition.productTypes) &&
        Objects.equals(this.productTags, discountCondition.productTags) &&
        Objects.equals(this.productCollections, discountCondition.productCollections) &&
        Objects.equals(this.customerGroups, discountCondition.customerGroups) &&
        Objects.equals(this.createdAt, discountCondition.createdAt) &&
        Objects.equals(this.updatedAt, discountCondition.updatedAt) &&
        Objects.equals(this.deletedAt, discountCondition.deletedAt) &&
        Objects.equals(this.metadata, discountCondition.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, operator, discountRuleId, discountRule, products, productTypes, productTags, productCollections, customerGroups, createdAt, updatedAt, deletedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class DiscountCondition {\n");
    
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    type: ").append(toIndentedString(type)).append("\n");
    sb.append("    operator: ").append(toIndentedString(operator)).append("\n");
    sb.append("    discountRuleId: ").append(toIndentedString(discountRuleId)).append("\n");
    sb.append("    discountRule: ").append(toIndentedString(discountRule)).append("\n");

...
public class StorePostCustomersCustomerAcceptClaimReq {
  @SerializedName("token")
  private String token = null;

  public StorePostCustomersCustomerAcceptClaimReq token(String token) {
    this.token = token;
    return this;
  }
   ...
   * @return token
  **/
  @Schema(required = true, description = "The invite token provided by the admin.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostCustomersCustomerAcceptClaimReq storePostCustomersCustomerAcceptClaimReq = (StorePostCustomersCustomerAcceptClaimReq) o;
    return Objects.equals(this.token, storePostCustomersCustomerAcceptClaimReq.token);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostCustomersCustomerAcceptClaimReq {\n");

 ...
 */
@Schema(description = "Sales Channel Stock Location link sales channels with stock locations.")
...
public class SalesChannelLocation {
  @SerializedName("id")
  ...
  private Object salesChannel = null;
  ...
  public SalesChannelLocation id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "scloc_01G8X9A7ESKAJXG2H0E6F1MW7A", required = true, description = "The Sales Channel Stock Location's ID")
  public String getId() {
    return id;
  }
  ...
  public SalesChannelLocation salesChannelId(String salesChannelId) {
  ...
  **/
  @Schema(example = "sc_01G8X9A7ESKAJXG2H0E6F1MW7A", required = true, description = "The id of the Sales Channel")
  ...
  public SalesChannelLocation locationId(String locationId) {
   ...
   * @return locationId
  **/
  @Schema(required = true, description = "The id of the Location Stock.")
  ...
  public SalesChannelLocation salesChannel(Object salesChannel) {
   ...
   * @return salesChannel
  **/
  @Schema(description = "The sales channel the location is associated with. Available if the relation `sales_channel` is expanded.")
  ...
  public SalesChannelLocation createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public SalesChannelLocation updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public SalesChannelLocation deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SalesChannelLocation salesChannelLocation = (SalesChannelLocation) o;
    return Objects.equals(this.id, salesChannelLocation.id) &&
        Objects.equals(this.salesChannelId, salesChannelLocation.salesChannelId) &&
        Objects.equals(this.locationId, salesChannelLocation.locationId) &&
        Objects.equals(this.salesChannel, salesChannelLocation.salesChannel) &&
        Objects.equals(this.createdAt, salesChannelLocation.createdAt) &&
        Objects.equals(this.updatedAt, salesChannelLocation.updatedAt) &&
        Objects.equals(this.deletedAt, salesChannelLocation.deletedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, salesChannelId, locationId, salesChannel, createdAt, updatedAt, deletedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class SalesChannelLocation {\n");

...
public class StorePostCartsCartShippingMethodReq {
  ...
  public StorePostCartsCartShippingMethodReq optionId(String optionId) {
   ...
   * @return optionId
  **/
  @Schema(required = true, description = "ID of the shipping option to create the method from")
  ...
  public StorePostCartsCartShippingMethodReq data(Object data) {
    this.data = data;
    return this;
  }
   ...
   * @return data
  **/
  @Schema(description = "Used to hold any data that the shipping method may need to process the fulfillment of the order. Look at the documentation for your installed fulfillment providers to find out what to send.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostCartsCartShippingMethodReq storePostCartsCartShippingMethodReq = (StorePostCartsCartShippingMethodReq) o;
    return Objects.equals(this.optionId, storePostCartsCartShippingMethodReq.optionId) &&
        Objects.equals(this.data, storePostCartsCartShippingMethodReq.data);
  }

  @Override
  public int hashCode() {
    return Objects.hash(optionId, data);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostCartsCartShippingMethodReq {\n");

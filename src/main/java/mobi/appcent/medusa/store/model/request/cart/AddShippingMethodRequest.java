 ...
 */
public class AddShippingMethodRequest extends BaseRequest<StoreCartsRes> {

    private final MedusaSdkClient client;
    private final String id;
    private StorePostCartsCartShippingMethodReq body;

    public AddShippingMethodRequest(MedusaSdkClient client, String id) {
        this.client = client;
        this.id = id;
    }

    public AddShippingMethodRequest body(StorePostCartsCartShippingMethodReq body) {
        this.body = body;
        return this;
    }
    ...
    protected Call buildCall() throws ApiException {
        ...
        String path = UrlConstant.CART_PATH + "/" + id + "/shipping-methods";

...
/**
 * StorePostPaymentCollectionsBatchSessionsReqSessions
 */
...
public class StorePostPaymentCollectionsBatchSessionsReqSessions {
  ...
  public StorePostPaymentCollectionsBatchSessionsReqSessions providerId(String providerId) {
   ...
   * @return providerId
  **/
  @Schema(required = true, description = "The ID of the Payment Provider.")
  ...
  public StorePostPaymentCollectionsBatchSessionsReqSessions amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public StorePostPaymentCollectionsBatchSessionsReqSessions sessionId(String sessionId) {
   ...
   * @return sessionId
  **/
  @Schema(description = "The ID of the Payment Session to be updated.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostPaymentCollectionsBatchSessionsReqSessions storePostPaymentCollectionsBatchSessionsReqSessions = (StorePostPaymentCollectionsBatchSessionsReqSessions) o;
    return Objects.equals(this.providerId, storePostPaymentCollectionsBatchSessionsReqSessions.providerId) &&
        Objects.equals(this.amount, storePostPaymentCollectionsBatchSessionsReqSessions.amount) &&
        Objects.equals(this.sessionId, storePostPaymentCollectionsBatchSessionsReqSessions.sessionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerId, amount, sessionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostPaymentCollectionsBatchSessionsReqSessions {\n");

...
public class StorePostSearchRes {
  @SerializedName("hits")
  private List hits = null;

  public StorePostSearchRes hits(List hits) {
    this.hits = hits;
    return this;
  }
   ...
   * @return hits
  **/
  @Schema(description = "Array of results. The format of the items depends on the search engine installed on the server.")
  public List getHits() {
    return hits;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostSearchRes storePostSearchRes = (StorePostSearchRes) o;
    return Objects.equals(this.hits, storePostSearchRes.hits);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostSearchRes {\n");

 ...
 */
@Schema(description = "Represents a Stock Location Address")
...
public class StockLocationAddressDTO {
  @SerializedName("id")
  ...
  public StockLocationAddressDTO id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "laddr_51G4ZW853Y6TFXWPG5ENJ81X42", description = "The stock location address' ID")
  public String getId() {
    return id;
  }
  ...
  public StockLocationAddressDTO address1(String address1) {
  ...
  **/
  ...
  public StockLocationAddressDTO address2(String address2) {
  ...
  **/
  ...
  public StockLocationAddressDTO company(String company) {
   ...
   * @return company
  **/
  @Schema(example = "Medusa", description = "Stock location company' name")
  ...
  public StockLocationAddressDTO city(String city) {
    this.city = city;
    return this;
  }
  ...
  **/
  ...
  public StockLocationAddressDTO countryCode(String countryCode) {
  ...
  **/
  ...
  public StockLocationAddressDTO phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  **/
  ...
  public StockLocationAddressDTO postalCode(String postalCode) {
  ...
  **/
  ...
  public StockLocationAddressDTO province(String province) {
  ...
  **/
  ...
  public StockLocationAddressDTO createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public StockLocationAddressDTO updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public StockLocationAddressDTO deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public StockLocationAddressDTO metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StockLocationAddressDTO stockLocationAddressDTO = (StockLocationAddressDTO) o;
    return Objects.equals(this.id, stockLocationAddressDTO.id) &&
        Objects.equals(this.address1, stockLocationAddressDTO.address1) &&
        Objects.equals(this.address2, stockLocationAddressDTO.address2) &&
        Objects.equals(this.company, stockLocationAddressDTO.company) &&
        Objects.equals(this.city, stockLocationAddressDTO.city) &&
        Objects.equals(this.countryCode, stockLocationAddressDTO.countryCode) &&
        Objects.equals(this.phone, stockLocationAddressDTO.phone) &&
        Objects.equals(this.postalCode, stockLocationAddressDTO.postalCode) &&
        Objects.equals(this.province, stockLocationAddressDTO.province) &&
        Objects.equals(this.createdAt, stockLocationAddressDTO.createdAt) &&
        Objects.equals(this.updatedAt, stockLocationAddressDTO.updatedAt) &&
        Objects.equals(this.deletedAt, stockLocationAddressDTO.deletedAt) &&
        Objects.equals(this.metadata, stockLocationAddressDTO.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, address1, address2, company, city, countryCode, phone, postalCode, province, createdAt, updatedAt, deletedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class StockLocationAddressDTO {\n");

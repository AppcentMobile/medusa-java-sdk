 ...
 */
@Schema(description = "Represents a fulfillment provider plugin and holds its installation status.")
...
public class FulfillmentProvider {
  ...
  public FulfillmentProvider id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "manual", required = true, description = "The id of the fulfillment provider as given by the plugin.")
  public String getId() {
    return id;
  }
  ...
  public FulfillmentProvider isInstalled(Boolean isInstalled) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FulfillmentProvider fulfillmentProvider = (FulfillmentProvider) o;
    return Objects.equals(this.id, fulfillmentProvider.id) &&
        Objects.equals(this.isInstalled, fulfillmentProvider.isInstalled);
  }
  ...
  public String toString() {
    ...
    sb.append("class FulfillmentProvider {\n");

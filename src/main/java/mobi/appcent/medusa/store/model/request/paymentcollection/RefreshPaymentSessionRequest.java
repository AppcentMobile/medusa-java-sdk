 ...
 */
public class RefreshPaymentSessionRequest extends BaseRequest<StorePaymentCollectionsSessionRes> {

    private final MedusaSdkClient client;
    private final String id;
    private final String sessionId;

    public RefreshPaymentSessionRequest(MedusaSdkClient client, String id, String sessionId) {
        this.client = client;
        this.id = id;
    ...
    protected Call buildCall() throws ApiException {
        String path = UrlConstant.PAYMENT_COLLECTION_PATH + "/" + id + "/sessions/" + sessionId;
    ...
    @Override
    public Type getType() {
        return new TypeToken<StorePaymentCollectionsSessionRes>(){}.getType();
    }
}

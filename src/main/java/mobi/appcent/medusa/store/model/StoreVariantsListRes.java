...
public class StoreVariantsListRes {
  @SerializedName("variants")
  private List<PricedVariant> variants = null;

  public StoreVariantsListRes variants(List<PricedVariant> variants) {
    this.variants = variants;
    return this;
  }

  public StoreVariantsListRes addVariantsItem(PricedVariant variantsItem) {
    if (this.variants == null) {
      this.variants = new ArrayList<PricedVariant>();
    }
  ...
  **/
  @Schema(description = "")
  public List<PricedVariant> getVariants() {
    return variants;
  }

  public void setVariants(List<PricedVariant> variants) {
    this.variants = variants;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StoreVariantsListRes storeVariantsListRes = (StoreVariantsListRes) o;
    return Objects.equals(this.variants, storeVariantsListRes.variants);
  }
  ...
  public String toString() {
    ...
    sb.append("class StoreVariantsListRes {\n");

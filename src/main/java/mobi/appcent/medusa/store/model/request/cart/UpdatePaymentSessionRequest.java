 ...
 */
public class UpdatePaymentSessionRequest extends BaseRequest<StoreCartsRes> {

    private final MedusaSdkClient client;
    private final String id;
    private final String providerId;
    private StorePostCartsCartPaymentSessionUpdateReq body;

    public UpdatePaymentSessionRequest(MedusaSdkClient client, String id, String providerId) {
        this.client = client;
        this.id = id;
        this.providerId = providerId;
    }

    public UpdatePaymentSessionRequest body(StorePostCartsCartPaymentSessionUpdateReq body) {
        this.body = body;
        return this;
    }
    ...
    protected Call buildCall() throws ApiException {
        ...
        String path = UrlConstant.CART_PATH + "/" + id + "/payment-session/" + providerId;

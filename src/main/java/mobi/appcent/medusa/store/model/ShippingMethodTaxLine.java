 ...
 */
@Schema(description = "Shipping Method Tax Line")
...
public class ShippingMethodTaxLine {
  @SerializedName("id")
  ...
  private Object shippingMethod = null;
  ...
  public ShippingMethodTaxLine id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "smtl_01G1G5V2DRX1SK6NQQ8VVX4HQ8", required = true, description = "The line item tax line's ID")
  public String getId() {
    return id;
  }
  ...
  public ShippingMethodTaxLine code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public ShippingMethodTaxLine name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ShippingMethodTaxLine rate(BigDecimal rate) {
    this.rate = rate;
    return this;
  }
   ...
   * @return rate
  **/
  @Schema(example = "10", required = true, description = "The numeric rate to charge tax by")
  ...
  public ShippingMethodTaxLine shippingMethodId(String shippingMethodId) {
  ...
  **/
  @Schema(example = "sm_01F0YET7DR2E7CYVSDHM593QG2", required = true, description = "The ID of the line item")
  ...
  public ShippingMethodTaxLine shippingMethod(Object shippingMethod) {
  ...
  **/
  @Schema(description = "Available if the relation `shipping_method` is expanded.")
  ...
  public ShippingMethodTaxLine createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ShippingMethodTaxLine updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ShippingMethodTaxLine metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ShippingMethodTaxLine shippingMethodTaxLine = (ShippingMethodTaxLine) o;
    return Objects.equals(this.id, shippingMethodTaxLine.id) &&
        Objects.equals(this.code, shippingMethodTaxLine.code) &&
        Objects.equals(this.name, shippingMethodTaxLine.name) &&
        Objects.equals(this.rate, shippingMethodTaxLine.rate) &&
        Objects.equals(this.shippingMethodId, shippingMethodTaxLine.shippingMethodId) &&
        Objects.equals(this.shippingMethod, shippingMethodTaxLine.shippingMethod) &&
        Objects.equals(this.createdAt, shippingMethodTaxLine.createdAt) &&
        Objects.equals(this.updatedAt, shippingMethodTaxLine.updatedAt) &&
        Objects.equals(this.metadata, shippingMethodTaxLine.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, code, name, rate, shippingMethodId, shippingMethod, createdAt, updatedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShippingMethodTaxLine {\n");

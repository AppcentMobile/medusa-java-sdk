...
public class InlineResponse422 {
  ...
  public InlineResponse422 code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse422 type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse422 message(String message) {
   ...
   /**
   * Human-readable message with details about the error
   * @return message
  **/
  @Schema(description = "Human-readable message with details about the error")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.code, inlineResponse422.code) &&
        Objects.equals(this.type, inlineResponse422.type) &&
        Objects.equals(this.message, inlineResponse422.message);
  }

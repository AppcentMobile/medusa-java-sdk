 ...
 */
@Schema(description = "Product Collections represents a group of Products that are related.")
...
public class ProductCollection {
  ...
  public ProductCollection id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "pcol_01F0YESBFAZ0DV6V831JXWH0BG", required = true, description = "The product collection's ID")
  public String getId() {
    return id;
  }
  ...
  public ProductCollection title(String title) {
    this.title = title;
    return this;
  }
   ...
   * @return title
  **/
  @Schema(example = "Summer Collection", required = true, description = "The title that the Product Collection is identified by.")
  ...
  public ProductCollection handle(String handle) {
    this.handle = handle;
    return this;
  }
   ...
   * @return handle
  **/
  @Schema(example = "summer-collection", required = true, description = "A unique string that identifies the Product Collection - can for example be used in slug structures.")
  ...
  public ProductCollection products(List<Object> products) {
    this.products = products;
    return this;
  }

  public ProductCollection addProductsItem(Object productsItem) {
   ...
   * @return products
  **/
  @Schema(description = "The Products contained in the Product Collection. Available if the relation `products` is expanded.")
  ...
  public ProductCollection createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ProductCollection updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ProductCollection deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public ProductCollection metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, productCollection.id) &&
        Objects.equals(this.title, productCollection.title) &&
        Objects.equals(this.handle, productCollection.handle) &&
        Objects.equals(this.products, productCollection.products) &&
        Objects.equals(this.createdAt, productCollection.createdAt) &&
        Objects.equals(this.updatedAt, productCollection.updatedAt) &&
        Objects.equals(this.deletedAt, productCollection.deletedAt) &&
        Objects.equals(this.metadata, productCollection.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, title, handle, products, createdAt, updatedAt, deletedAt, metadata);
  }

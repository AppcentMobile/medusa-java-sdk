 ...
 */
@Schema(description = "Represents a Line Item Tax Line")
...
public class LineItemTaxLine {
  ...
  public LineItemTaxLine id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "litl_01G1G5V2DRX1SK6NQQ8VVX4HQ8", required = true, description = "The line item tax line's ID")
  public String getId() {
    return id;
  }
  ...
  public LineItemTaxLine code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public LineItemTaxLine name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public LineItemTaxLine rate(BigDecimal rate) {
    this.rate = rate;
    return this;
  }
  ...
  **/
  ...
  public LineItemTaxLine itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
  ...
  **/
  ...
  public LineItemTaxLine item(Object item) {
    this.item = item;
    return this;
  }
  ...
  **/
  ...
  public LineItemTaxLine createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public LineItemTaxLine updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public LineItemTaxLine metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LineItemTaxLine lineItemTaxLine = (LineItemTaxLine) o;
    return Objects.equals(this.id, lineItemTaxLine.id) &&
        Objects.equals(this.code, lineItemTaxLine.code) &&
        Objects.equals(this.name, lineItemTaxLine.name) &&
        Objects.equals(this.rate, lineItemTaxLine.rate) &&
        Objects.equals(this.itemId, lineItemTaxLine.itemId) &&
        Objects.equals(this.item, lineItemTaxLine.item) &&
        Objects.equals(this.createdAt, lineItemTaxLine.createdAt) &&
        Objects.equals(this.updatedAt, lineItemTaxLine.updatedAt) &&
        Objects.equals(this.metadata, lineItemTaxLine.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, code, name, rate, itemId, item, createdAt, updatedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class LineItemTaxLine {\n");

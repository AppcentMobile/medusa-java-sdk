 ...
 */
@Schema(description = "Associates a tax rate with a product to indicate that the product is taxed in a certain way")
...
public class ProductTaxRate {
  ...
  public ProductTaxRate productId(String productId) {
   ...
   * @return productId
  **/
  @Schema(example = "prod_01G1G5V2MBA328390B5AXJ610F", required = true, description = "The ID of the Product")
  ...
  public ProductTaxRate product(Product product) {
  ...
  **/
  ...
  public ProductTaxRate rateId(String rateId) {
    this.rateId = rateId;
    return this;
  }
  ...
  **/
  ...
  public ProductTaxRate taxRate(TaxRate taxRate) {
  ...
  **/
  ...
  public ProductTaxRate createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ProductTaxRate updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ProductTaxRate metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProductTaxRate productTaxRate = (ProductTaxRate) o;
    return Objects.equals(this.productId, productTaxRate.productId) &&
        Objects.equals(this.product, productTaxRate.product) &&
        Objects.equals(this.rateId, productTaxRate.rateId) &&
        Objects.equals(this.taxRate, productTaxRate.taxRate) &&
        Objects.equals(this.createdAt, productTaxRate.createdAt) &&
        Objects.equals(this.updatedAt, productTaxRate.updatedAt) &&
        Objects.equals(this.metadata, productTaxRate.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productId, product, rateId, taxRate, createdAt, updatedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductTaxRate {\n");

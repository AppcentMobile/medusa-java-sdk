 ...
 */
public class CreateCartRequest extends BaseRequest<StoreCartsRes> {

    private final MedusaSdkClient client;
    private StorePostCartReq body;

    public CreateCartRequest(MedusaSdkClient client) {
        this.client = client;
    }

    public CreateCartRequest body(StorePostCartReq body) {
        this.body = body;
        return this;
    }
    ...
    protected Call buildCall() throws ApiException {
        ...
        String path = UrlConstant.CART_PATH;

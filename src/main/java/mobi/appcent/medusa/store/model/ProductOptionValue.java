 ...
 */
@Schema(description = "A value given to a Product Variant's option set. Product Variant have a Product Option Value for each of the Product Options defined on the Product.")
...
public class ProductOptionValue {
  ...
  public ProductOptionValue id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "optval_01F0YESHR7S6ECD03RF6W12DSJ", required = true, description = "The product option value's ID")
  public String getId() {
    return id;
  }
  ...
  public ProductOptionValue value(String value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @Schema(example = "large", required = true, description = "The value that the Product Variant has defined for the specific Product Option (e.g. if the Product Option is \\\"Size\\\" this value could be `Small`, `Medium` or `Large`).")
  ...
  public ProductOptionValue optionId(String optionId) {
   ...
   * @return optionId
  **/
  @Schema(example = "opt_01F0YESHQBZVKCEXJ24BS6PCX3", required = true, description = "The ID of the Product Option that the Product Option Value is defined for.")
  ...
  public ProductOptionValue option(Object option) {
    this.option = option;
    return this;
  }
   ...
   * @return option
  **/
  @Schema(description = "Available if the relation `option` is expanded.")
  ...
  public ProductOptionValue variantId(String variantId) {
   ...
   * @return variantId
  **/
  @Schema(example = "variant_01G1G5V2MRX2V3PVSR2WXYPFB6", required = true, description = "The ID of the Product Variant that the Product Option Value is defined for.")
  ...
  public ProductOptionValue variant(Object variant) {
   ...
   * @return variant
  **/
  @Schema(description = "Available if the relation `variant` is expanded.")
  ...
  public ProductOptionValue createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ProductOptionValue updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ProductOptionValue deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public ProductOptionValue metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, productOptionValue.id) &&
        Objects.equals(this.value, productOptionValue.value) &&
        Objects.equals(this.optionId, productOptionValue.optionId) &&
        Objects.equals(this.option, productOptionValue.option) &&
        Objects.equals(this.variantId, productOptionValue.variantId) &&
        Objects.equals(this.variant, productOptionValue.variant) &&
        Objects.equals(this.createdAt, productOptionValue.createdAt) &&
        Objects.equals(this.updatedAt, productOptionValue.updatedAt) &&
        Objects.equals(this.deletedAt, productOptionValue.deletedAt) &&
        Objects.equals(this.metadata, productOptionValue.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, value, optionId, option, variantId, variant, createdAt, updatedAt, deletedAt, metadata);
  }

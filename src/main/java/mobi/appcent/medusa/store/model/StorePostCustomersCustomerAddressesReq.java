...
public class StorePostCustomersCustomerAddressesReq {
  @SerializedName("address")
  private AllOfStorePostCustomersCustomerAddressesReqAddress address = null;

  public StorePostCustomersCustomerAddressesReq address(AllOfStorePostCustomersCustomerAddressesReqAddress address) {
   ...
   * @return address
  **/
  @Schema(required = true, description = "The Address to add to the Customer.")
  public AllOfStorePostCustomersCustomerAddressesReqAddress getAddress() {
    return address;
  }

  public void setAddress(AllOfStorePostCustomersCustomerAddressesReqAddress address) {
    this.address = address;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostCustomersCustomerAddressesReq storePostCustomersCustomerAddressesReq = (StorePostCustomersCustomerAddressesReq) o;
    return Objects.equals(this.address, storePostCustomersCustomerAddressesReq.address);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostCustomersCustomerAddressesReq {\n");

...
public class StoreCompleteCartRes {
  /**
  ...
  @SerializedName("data")
  private OneOfStoreCompleteCartResData data = null;

  public StoreCompleteCartRes type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @Schema(description = "The type of the data property.")
  ...
  public StoreCompleteCartRes data(OneOfStoreCompleteCartResData data) {
    this.data = data;
    return this;
  }
   ...
   * @return data
  **/
  @Schema(description = "The data of the result object. Its type depends on the type field.")
  public OneOfStoreCompleteCartResData getData() {
    return data;
  }

  public void setData(OneOfStoreCompleteCartResData data) {
    this.data = data;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StoreCompleteCartRes storeCompleteCartRes = (StoreCompleteCartRes) o;
    return Objects.equals(this.type, storeCompleteCartRes.type) &&
        Objects.equals(this.data, storeCompleteCartRes.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class StoreCompleteCartRes {\n");

 ...
 */
public class CreateSwapRequest extends BaseRequest<StoreSwapsRes> {

    private final MedusaSdkClient client;
    private StorePostSwapsReq body;

    public CreateSwapRequest(MedusaSdkClient client) {
        this.client = client;
    }

    public CreateSwapRequest body(StorePostSwapsReq body) {
        this.body = body;
        return this;
    }
    ...
    protected Call buildCall() throws ApiException {
        String path = UrlConstant.SWAP_PATH;

 ...
 */
@Schema(description = "Claim Tags are user defined tags that can be assigned to claim items for easy filtering and grouping.")
...
public class ClaimTag {
   ...
   * @return id
  **/
  @Schema(example = "ctag_01G8ZCC5Y63B95V6B5SHBZ91S4", required = true, description = "The claim tag's ID")
  public String getId() {
    return id;
  }
  ...
  public ClaimTag value(String value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @Schema(example = "Damaged", required = true, description = "The value that the claim tag holds")
  ...
  public ClaimTag createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ClaimTag updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ClaimTag deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public ClaimTag metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ClaimTag claimTag = (ClaimTag) o;
    return Objects.equals(this.id, claimTag.id) &&
        Objects.equals(this.value, claimTag.value) &&
        Objects.equals(this.createdAt, claimTag.createdAt) &&
        Objects.equals(this.updatedAt, claimTag.updatedAt) &&
        Objects.equals(this.deletedAt, claimTag.deletedAt) &&
        Objects.equals(this.metadata, claimTag.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, value, createdAt, updatedAt, deletedAt, metadata);
  }

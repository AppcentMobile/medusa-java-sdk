...
/**
 * StorePostCartsCartReqGiftCards
 */
...
public class StorePostCartsCartReqGiftCards {
  @SerializedName("code")
  private String code = null;

  public StorePostCartsCartReqGiftCards code(String code) {
    this.code = code;
    return this;
  }
   ...
   * @return code
  **/
  @Schema(required = true, description = "The code that a Gift Card is identified by.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostCartsCartReqGiftCards storePostCartsCartReqGiftCards = (StorePostCartsCartReqGiftCards) o;
    return Objects.equals(this.code, storePostCartsCartReqGiftCards.code);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostCartsCartReqGiftCards {\n");

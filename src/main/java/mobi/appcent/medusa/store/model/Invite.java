 ...
 */
@Schema(description = "Represents an invite")
...
public class Invite {
   ...
   * @return id
  **/
  @Schema(example = "invite_01G8TKE4XYCTHSCK2GDEP47RE1", required = true, description = "The invite's ID")
  public String getId() {
    return id;
  }
  ...
  public Invite userEmail(String userEmail) {
   ...
   * @return userEmail
  **/
  @Schema(required = true, description = "The email of the user being invited.")
  ...
  **/
   ...
   * @return accepted
  **/
  @Schema(required = true, description = "Whether the invite was accepted or not.")
  ...
  public Invite token(String token) {
    this.token = token;
    return this;
  }
   ...
   * @return token
  **/
  @Schema(required = true, description = "The token used to accept the invite.")
   ...
   * @return expiresAt
  **/
  @Schema(required = true, description = "The date the invite expires at.")
  ...
  public Invite createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public Invite updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public Invite deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public Invite metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, invite.id) &&
        Objects.equals(this.userEmail, invite.userEmail) &&
        Objects.equals(this.role, invite.role) &&
        Objects.equals(this.accepted, invite.accepted) &&
        Objects.equals(this.token, invite.token) &&
        ...
        Objects.equals(this.metadata, invite.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, userEmail, role, accepted, token, expiresAt, createdAt, updatedAt, deletedAt, metadata);
  }

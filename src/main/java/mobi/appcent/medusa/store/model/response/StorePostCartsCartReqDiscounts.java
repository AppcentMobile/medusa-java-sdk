...
public class StorePostCartsCartReqDiscounts {
  @SerializedName("code")
  private String code = null;

  public StorePostCartsCartReqDiscounts code(String code) {
    this.code = code;
    return this;
  }
   ...
   * @return code
  **/
  @Schema(required = true, description = "The code that a Discount is identifed by.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostCartsCartReqDiscounts storePostCartsCartReqDiscounts = (StorePostCartsCartReqDiscounts) o;
    return Objects.equals(this.code, storePostCartsCartReqDiscounts.code);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostCartsCartReqDiscounts {\n");

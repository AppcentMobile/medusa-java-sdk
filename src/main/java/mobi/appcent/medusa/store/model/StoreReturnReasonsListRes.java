...
public class StoreReturnReasonsListRes {
  @SerializedName("return_reasons")
  private List<ReturnReason> returnReasons = null;

  public StoreReturnReasonsListRes returnReasons(List<ReturnReason> returnReasons) {
    this.returnReasons = returnReasons;
    return this;
  }

  public StoreReturnReasonsListRes addReturnReasonsItem(ReturnReason returnReasonsItem) {
    if (this.returnReasons == null) {
      this.returnReasons = new ArrayList<ReturnReason>();
    }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StoreReturnReasonsListRes storeReturnReasonsListRes = (StoreReturnReasonsListRes) o;
    return Objects.equals(this.returnReasons, storeReturnReasonsListRes.returnReasons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(returnReasons);
  }
  ...
  public String toString() {
    ...
    sb.append("class StoreReturnReasonsListRes {\n");

 ...
 */
@Schema(description = "Product Variant Inventory Items link variants with inventory items and denote the number of inventory items constituting a variant.")
...
public class ProductVariantInventoryItem {
  ...
  public ProductVariantInventoryItem id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "pvitem_01G8X9A7ESKAJXG2H0E6F1MW7A", required = true, description = "The product variant inventory item's ID")
  public String getId() {
    return id;
  }
  ...
  public ProductVariantInventoryItem inventoryItemId(String inventoryItemId) {
  ...
  **/
  @Schema(required = true, description = "The id of the inventory item")
  ...
  public ProductVariantInventoryItem variantId(String variantId) {
   ...
   * @return variantId
  **/
  @Schema(required = true, description = "The id of the variant.")
  ...
  public ProductVariantInventoryItem variant(Object variant) {
   ...
   * @return variant
  **/
  @Schema(description = "A ProductVariant object. Available if the relation `variant` is expanded.")
  ...
  public ProductVariantInventoryItem requiredQuantity(Integer requiredQuantity) {
  ...
  **/
  @Schema(required = true, description = "The quantity of an inventory item required for one quantity of the variant.")
  ...
  public ProductVariantInventoryItem createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ProductVariantInventoryItem updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ProductVariantInventoryItem deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProductVariantInventoryItem productVariantInventoryItem = (ProductVariantInventoryItem) o;
    return Objects.equals(this.id, productVariantInventoryItem.id) &&
        Objects.equals(this.inventoryItemId, productVariantInventoryItem.inventoryItemId) &&
        Objects.equals(this.variantId, productVariantInventoryItem.variantId) &&
        Objects.equals(this.variant, productVariantInventoryItem.variant) &&
        Objects.equals(this.requiredQuantity, productVariantInventoryItem.requiredQuantity) &&
        Objects.equals(this.createdAt, productVariantInventoryItem.createdAt) &&
        Objects.equals(this.updatedAt, productVariantInventoryItem.updatedAt) &&
        Objects.equals(this.deletedAt, productVariantInventoryItem.deletedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, inventoryItemId, variantId, variant, requiredQuantity, createdAt, updatedAt, deletedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductVariantInventoryItem {\n");

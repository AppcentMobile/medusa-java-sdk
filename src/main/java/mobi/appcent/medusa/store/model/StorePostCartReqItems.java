...
public class StorePostCartReqItems {
  ...
  public StorePostCartReqItems variantId(String variantId) {
   ...
   * @return variantId
  **/
  @Schema(required = true, description = "The id of the Product Variant to generate a Line Item from.")
  ...
  public StorePostCartReqItems quantity(Integer quantity) {
   ...
   * @return quantity
  **/
  @Schema(required = true, description = "The quantity of the Product Variant to add")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostCartReqItems storePostCartReqItems = (StorePostCartReqItems) o;
    return Objects.equals(this.variantId, storePostCartReqItems.variantId) &&
        Objects.equals(this.quantity, storePostCartReqItems.quantity);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostCartReqItems {\n");

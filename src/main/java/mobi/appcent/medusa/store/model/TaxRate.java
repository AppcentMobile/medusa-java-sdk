 ...
 */
@Schema(description = "A Tax Rate can be used to associate a certain rate to charge on products within a given Region")
...
public class TaxRate {
  ...
  @SerializedName("product_type_count")
  private Integer productTypeCount = null;

  @SerializedName("shipping_option_count")
  private Integer shippingOptionCount = null;
   ...
   * @return id
  **/
  @Schema(example = "txr_01G8XDBAWKBHHJRKH0AV02KXBR", required = true, description = "The tax rate's ID")
  public String getId() {
    return id;
  }
   ...
   * @return rate
  **/
  @Schema(example = "10", required = true, description = "The numeric rate to charge")
   ...
   * @return code
  **/
  @Schema(example = "tax01", required = true, description = "A code to identify the tax type by")
   ...
   * @return name
  **/
  @Schema(example = "Tax Example", required = true, description = "A human friendly name for the tax")
  ...
  public TaxRate regionId(String regionId) {
   ...
   * @return regionId
  **/
  @Schema(example = "reg_01G1G5V26T9H8Y0M4JNE3YGA4G", required = true, description = "The id of the Region that the rate belongs to")
  ...
  public TaxRate region(Object region) {
    this.region = region;
    return this;
  }
  ...
  **/
  ...
  public TaxRate products(List<Product> products) {
    this.products = products;
    return this;
  }

  public TaxRate addProductsItem(Product productsItem) {
   ...
   * @return products
  **/
  @Schema(description = "The products that belong to this tax rate. Available if the relation `products` is expanded.")
  ...
  public TaxRate productTypes(List<ProductType> productTypes) {
    this.productTypes = productTypes;
    return this;
  }

  public TaxRate addProductTypesItem(ProductType productTypesItem) {
   ...
   * @return productTypes
  **/
  @Schema(description = "The product types that belong to this tax rate. Available if the relation `product_types` is expanded.")
  ...
  public TaxRate shippingOptions(List<ShippingOption> shippingOptions) {
    this.shippingOptions = shippingOptions;
    return this;
  }

  public TaxRate addShippingOptionsItem(ShippingOption shippingOptionsItem) {
  ...
  **/
  @Schema(description = "The shipping options that belong to this tax rate. Available if the relation `shipping_options` is expanded.")
  ...
  public TaxRate productCount(Integer productCount) {
   ...
   * @return productCount
  **/
  @Schema(example = "10", description = "The count of products")
  ...
  public TaxRate productTypeCount(Integer productTypeCount) {
  ...
  **/
  @Schema(example = "2", description = "The count of product types")
  ...
  public TaxRate shippingOptionCount(Integer shippingOptionCount) {
   ...
   * @return shippingOptionCount
  **/
  @Schema(example = "1", description = "The count of shipping options")
  public Integer getShippingOptionCount() {
    return shippingOptionCount;
  }

  public void setShippingOptionCount(Integer shippingOptionCount) {
    this.shippingOptionCount = shippingOptionCount;
  }

  public TaxRate createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public TaxRate updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public TaxRate metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, taxRate.id) &&
        ...
        Objects.equals(this.code, taxRate.code) &&
        Objects.equals(this.name, taxRate.name) &&
        Objects.equals(this.regionId, taxRate.regionId) &&
        Objects.equals(this.region, taxRate.region) &&
        Objects.equals(this.products, taxRate.products) &&
        Objects.equals(this.productTypes, taxRate.productTypes) &&
        Objects.equals(this.shippingOptions, taxRate.shippingOptions) &&
        Objects.equals(this.productCount, taxRate.productCount) &&
        Objects.equals(this.productTypeCount, taxRate.productTypeCount) &&
        Objects.equals(this.shippingOptionCount, taxRate.shippingOptionCount) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, rate, code, name, regionId, region, products, productTypes, shippingOptions, productCount, productTypeCount, shippingOptionCount, createdAt, updatedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("    productTypeCount: ").append(toIndentedString(productTypeCount)).append("\n");
    sb.append("    shippingOptionCount: ").append(toIndentedString(shippingOptionCount)).append("\n");

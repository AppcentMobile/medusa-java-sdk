 ...
 */
public class UpdateCustomerRequest extends BaseRequest<StoreCustomersRes> {

    private final MedusaSdkClient client;
    private StorePostCustomersCustomerReq body;

    public UpdateCustomerRequest(MedusaSdkClient client) {
        this.client = client;
    }

    public UpdateCustomerRequest body(StorePostCustomersCustomerReq body) {
        this.body = body;
        return this;
    }

 ...
 */
@Schema(description = "Associates a discount condition with a product")
...
public class DiscountConditionProduct {
  ...
  public DiscountConditionProduct productId(String productId) {
   ...
   * @return productId
  **/
  @Schema(example = "prod_01G1G5V2MBA328390B5AXJ610F", required = true, description = "The ID of the Product Tag")
  ...
  public DiscountConditionProduct conditionId(String conditionId) {
  ...
  **/
  ...
  public DiscountConditionProduct product(Product product) {
  ...
  **/
  ...
  public DiscountConditionProduct discountCondition(DiscountCondition discountCondition) {
  ...
  **/
  ...
  public DiscountConditionProduct createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public DiscountConditionProduct updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public DiscountConditionProduct metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DiscountConditionProduct discountConditionProduct = (DiscountConditionProduct) o;
    return Objects.equals(this.productId, discountConditionProduct.productId) &&
        Objects.equals(this.conditionId, discountConditionProduct.conditionId) &&
        Objects.equals(this.product, discountConditionProduct.product) &&
        Objects.equals(this.discountCondition, discountConditionProduct.discountCondition) &&
        Objects.equals(this.createdAt, discountConditionProduct.createdAt) &&
        Objects.equals(this.updatedAt, discountConditionProduct.updatedAt) &&
        Objects.equals(this.metadata, discountConditionProduct.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productId, conditionId, product, discountCondition, createdAt, updatedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class DiscountConditionProduct {\n");

 ...
 */
@Schema(description = "Product Tags can be added to Products for easy filtering and grouping.")
...
public class ProductTag {
  ...
  public ProductTag id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "ptag_01G8K2MTMG9168F2B70S1TAVK3", required = true, description = "The product tag's ID")
  public String getId() {
    return id;
  }
  ...
  public ProductTag value(String value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @Schema(example = "Pants", required = true, description = "The value that the Product Tag represents")
  ...
  public ProductTag createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ProductTag updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ProductTag deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public ProductTag metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, productTag.id) &&
        Objects.equals(this.value, productTag.value) &&
        Objects.equals(this.createdAt, productTag.createdAt) &&
        Objects.equals(this.updatedAt, productTag.updatedAt) &&
        Objects.equals(this.deletedAt, productTag.deletedAt) &&
        Objects.equals(this.metadata, productTag.metadata);
  }

 ...
 */
@Schema(description = "Associates a discount condition with a product collection")
...
public class DiscountConditionProductCollection {
  @SerializedName("product_collection_id")
  ...
  private DiscountCondition discountCondition = null;
  ...
  public DiscountConditionProductCollection productCollectionId(String productCollectionId) {
  ...
  **/
  @Schema(example = "pcol_01F0YESBFAZ0DV6V831JXWH0BG", required = true, description = "The ID of the Product Collection")
  ...
  public DiscountConditionProductCollection conditionId(String conditionId) {
   ...
   * @return conditionId
  **/
  @Schema(example = "discon_01G8X9A7ESKAJXG2H0E6F1MW7A", required = true, description = "The ID of the Discount Condition")
  ...
  public DiscountConditionProductCollection productCollection(ProductCollection productCollection) {
  ...
  **/
  ...
  public DiscountConditionProductCollection discountCondition(DiscountCondition discountCondition) {
  ...
  **/
  ...
  public DiscountConditionProductCollection createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public DiscountConditionProductCollection updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public DiscountConditionProductCollection metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DiscountConditionProductCollection discountConditionProductCollection = (DiscountConditionProductCollection) o;
    return Objects.equals(this.productCollectionId, discountConditionProductCollection.productCollectionId) &&
        Objects.equals(this.conditionId, discountConditionProductCollection.conditionId) &&
        Objects.equals(this.productCollection, discountConditionProductCollection.productCollection) &&
        Objects.equals(this.discountCondition, discountConditionProductCollection.discountCondition) &&
        Objects.equals(this.createdAt, discountConditionProductCollection.createdAt) &&
        Objects.equals(this.updatedAt, discountConditionProductCollection.updatedAt) &&
        Objects.equals(this.metadata, discountConditionProductCollection.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productCollectionId, conditionId, productCollection, discountCondition, createdAt, updatedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class DiscountConditionProductCollection {\n");
    
    sb.append("    productCollectionId: ").append(toIndentedString(productCollectionId)).append("\n");
    sb.append("    conditionId: ").append(toIndentedString(conditionId)).append("\n");
    sb.append("    productCollection: ").append(toIndentedString(productCollection)).append("\n");
    sb.append("    discountCondition: ").append(toIndentedString(discountCondition)).append("\n");

...
public class StorePostCartsCartLineItemsReq {
  ...
  public StorePostCartsCartLineItemsReq variantId(String variantId) {
   ...
   * @return variantId
  **/
  @Schema(required = true, description = "The id of the Product Variant to generate the Line Item from.")
  ...
  public StorePostCartsCartLineItemsReq quantity(BigDecimal quantity) {
   ...
   * @return quantity
  **/
  @Schema(required = true, description = "The quantity of the Product Variant to add to the Line Item.")
  ...
  public StorePostCartsCartLineItemsReq metadata(Object metadata) {
   ...
   * @return metadata
  **/
  @Schema(description = "An optional key-value map with additional details about the Line Item.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostCartsCartLineItemsReq storePostCartsCartLineItemsReq = (StorePostCartsCartLineItemsReq) o;
    return Objects.equals(this.variantId, storePostCartsCartLineItemsReq.variantId) &&
        Objects.equals(this.quantity, storePostCartsCartLineItemsReq.quantity) &&
        Objects.equals(this.metadata, storePostCartsCartLineItemsReq.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(variantId, quantity, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostCartsCartLineItemsReq {\n");

...
public class PricedProduct extends Product {
  ...
  private List<PricedVariant> pricedProductVariants = null;

  public PricedProduct pricedProductVariants(List<PricedVariant> pricedProductVariants) {
    this.pricedProductVariants = pricedProductVariants;
    return this;
  }

  public PricedProduct addPricedProductVariantsItem(PricedVariant pricedProductVariantsItem) {
    if (this.pricedProductVariants == null) {
      this.pricedProductVariants = new ArrayList<PricedVariant>();
    }
    this.pricedProductVariants.add(pricedProductVariantsItem);
    return this;
  }

   /**
   * Get pricedProductVariants
   * @return pricedProductVariants
  **/
  @Schema(description = "")
  public List<PricedVariant> getPricedProductVariants() {
    return pricedProductVariants;
  }

  public void setPricedProductVariants(List<PricedVariant> pricedProductVariants) {
    this.pricedProductVariants = pricedProductVariants;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PricedProduct pricedProduct = (PricedProduct) o;
    return Objects.equals(this.pricedProductVariants, pricedProduct.pricedProductVariants) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pricedProductVariants, super.hashCode());
  }

...
public class MultipleErrors implements InlineResponse400 {
  @SerializedName("errors")
  private List<Error> errors = null;

  @SerializedName("message")
  private String message = "Provided request body contains errors. Please check the data and retry the request";

  public MultipleErrors errors(List<Error> errors) {
    this.errors = errors;
    return this;
  }

  public MultipleErrors addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public MultipleErrors message(String message) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MultipleErrors multipleErrors = (MultipleErrors) o;
    return Objects.equals(this.errors, multipleErrors.errors) &&
        Objects.equals(this.message, multipleErrors.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultipleErrors {\n");

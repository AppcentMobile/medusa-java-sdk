...
public class StorePostSwapsReqReturnItems {
  ...
  public StorePostSwapsReqReturnItems itemId(String itemId) {
    this.itemId = itemId;
    return this;
  }
   ...
   * @return itemId
  **/
  @Schema(required = true, description = "The ID of the Line Item from the Order.")
  ...
  public StorePostSwapsReqReturnItems quantity(Integer quantity) {
   ...
   * @return quantity
  **/
  @Schema(required = true, description = "The quantity to swap.")
  ...
  public StorePostSwapsReqReturnItems reasonId(String reasonId) {
   ...
   * @return reasonId
  **/
  @Schema(description = "The ID of the reason of this return.")
  ...
  public StorePostSwapsReqReturnItems note(String note) {
    this.note = note;
    return this;
  }
   ...
   * @return note
  **/
  @Schema(description = "The note to add to the item being swapped.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostSwapsReqReturnItems storePostSwapsReqReturnItems = (StorePostSwapsReqReturnItems) o;
    return Objects.equals(this.itemId, storePostSwapsReqReturnItems.itemId) &&
        Objects.equals(this.quantity, storePostSwapsReqReturnItems.quantity) &&
        Objects.equals(this.reasonId, storePostSwapsReqReturnItems.reasonId) &&
        Objects.equals(this.note, storePostSwapsReqReturnItems.note);
  }

  @Override
  public int hashCode() {
    return Objects.hash(itemId, quantity, reasonId, note);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostSwapsReqReturnItems {\n");

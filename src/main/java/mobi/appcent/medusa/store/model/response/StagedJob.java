 ...
 */
@Schema(description = "A staged job resource")
...
public class StagedJob {
   ...
   * @return id
  **/
  @Schema(example = "job_01F0YET7BZTARY9MKN1SJ7AAXF", required = true, description = "The staged job's ID")
  public String getId() {
    return id;
  }
  ...
  public StagedJob eventName(String eventName) {
   ...
   * @return eventName
  **/
  @Schema(example = "order.placed", required = true, description = "The name of the event")
  ...
  public StagedJob data(Object data) {
    this.data = data;
    return this;
  }
   ...
   * @return data
  **/
  @Schema(example = "{}", required = true, description = "Data necessary for the job")
  ...
  public StagedJob option(Object option) {
    this.option = option;
    return this;
  }
   ...
   * @return option
  **/
  @Schema(example = "{}", description = "The staged job's option")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StagedJob stagedJob = (StagedJob) o;
    return Objects.equals(this.id, stagedJob.id) &&
        Objects.equals(this.eventName, stagedJob.eventName) &&
        Objects.equals(this.data, stagedJob.data) &&
        Objects.equals(this.option, stagedJob.option);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, eventName, data, option);
  }

 ...
 */
@Schema(description = "Product Type can be added to Products for filtering and reporting purposes.")
...
public class ProductType {
  ...
  public ProductType id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "ptyp_01G8X9A7ESKAJXG2H0E6F1MW7A", required = true, description = "The product type's ID")
  public String getId() {
    return id;
  }
   ...
   * @return value
  **/
  @Schema(example = "Clothing", required = true, description = "The value that the Product Type represents.")
  ...
  public ProductType createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ProductType updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ProductType deletedAt(OffsetDateTime deletedAt) {
  ...
  **/
  ...
  public ProductType metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, productType.id) &&
        Objects.equals(this.value, productType.value) &&
        Objects.equals(this.createdAt, productType.createdAt) &&
        Objects.equals(this.updatedAt, productType.updatedAt) &&
        Objects.equals(this.deletedAt, productType.deletedAt) &&
        Objects.equals(this.metadata, productType.metadata);
  }

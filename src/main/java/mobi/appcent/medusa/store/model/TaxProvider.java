 ...
 */
@Schema(description = "The tax service used to calculate taxes")
...
public class TaxProvider {
   ...
   * @return id
  **/
  @Schema(example = "manual", required = true, description = "The id of the tax provider as given by the plugin.")
  public String getId() {
    return id;
  }
  ...
  public TaxProvider isInstalled(Boolean isInstalled) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, taxProvider.id) &&
        Objects.equals(this.isInstalled, taxProvider.isInstalled);
  }

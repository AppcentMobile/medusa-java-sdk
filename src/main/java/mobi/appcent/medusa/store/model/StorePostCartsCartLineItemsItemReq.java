...
public class StorePostCartsCartLineItemsItemReq {
  @SerializedName("quantity")
  private BigDecimal quantity = null;

  public StorePostCartsCartLineItemsItemReq quantity(BigDecimal quantity) {
   ...
   * @return quantity
  **/
  @Schema(required = true, description = "The quantity to set the Line Item to.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostCartsCartLineItemsItemReq storePostCartsCartLineItemsItemReq = (StorePostCartsCartLineItemsItemReq) o;
    return Objects.equals(this.quantity, storePostCartsCartLineItemsItemReq.quantity);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostCartsCartLineItemsItemReq {\n");

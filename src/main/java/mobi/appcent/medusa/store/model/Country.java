...
public class Country {
   ...
   * @return id
  **/
  @Schema(example = "109", required = true, description = "The country's ID")
  public String getId() {
    return id;
  }
   ...
   * @return iso2
  **/
  @Schema(example = "it", required = true, description = "The 2 character ISO code of the country in lower case")
   ...
   * @return iso3
  **/
  @Schema(example = "ita", required = true, description = "The 2 character ISO code of the country in lower case")
   ...
   * @return numCode
  **/
  @Schema(example = "380", required = true, description = "The numerical ISO code for the country.")
   ...
   * @return name
  **/
  @Schema(example = "ITALY", required = true, description = "The normalized country name in upper case.")
   ...
   * @return displayName
  **/
  @Schema(example = "Italy", required = true, description = "The country name appropriate for display.")
  ...
  public Country regionId(String regionId) {
   ...
   * @return regionId
  **/
  @Schema(example = "reg_01G1G5V26T9H8Y0M4JNE3YGA4G", required = true, description = "The region ID this country is associated with.")
  ...
  public Country region(Object region) {
    this.region = region;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, country.id) &&
        ...
        Objects.equals(this.displayName, country.displayName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, iso2, iso3, numCode, name, displayName, regionId, region);
  }

 ...
 */
@Schema(description = "Holds mapping between Publishable API keys and Sales Channels")
...
public class PublishableApiKeySalesChannel {
  ...
  @SerializedName("publishable_key_id")
  private String publishableKeyId = null;

  public PublishableApiKeySalesChannel salesChannelId(String salesChannelId) {
  ...
  **/
  @Schema(example = "sc_01G1G5V21KADXNGH29BJMAJ4B4", required = true, description = "The sales channel's ID")
  ...
  public PublishableApiKeySalesChannel publishableKeyId(String publishableKeyId) {
    this.publishableKeyId = publishableKeyId;
    return this;
  }

   /**
   * The publishable API key&#x27;s ID
   * @return publishableKeyId
  **/
  @Schema(example = "pak_01G1G5V21KADXNGH29BJMAJ4B4", required = true, description = "The publishable API key's ID")
  public String getPublishableKeyId() {
    return publishableKeyId;
  }

  public void setPublishableKeyId(String publishableKeyId) {
    this.publishableKeyId = publishableKeyId;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PublishableApiKeySalesChannel publishableApiKeySalesChannel = (PublishableApiKeySalesChannel) o;
    return Objects.equals(this.salesChannelId, publishableApiKeySalesChannel.salesChannelId) &&
        Objects.equals(this.publishableKeyId, publishableApiKeySalesChannel.publishableKeyId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(salesChannelId, publishableKeyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PublishableApiKeySalesChannel {\n");
    
    sb.append("    salesChannelId: ").append(toIndentedString(salesChannelId)).append("\n");
    sb.append("    publishableKeyId: ").append(toIndentedString(publishableKeyId)).append("\n");
    sb.append("}");
    return sb.toString();
  }

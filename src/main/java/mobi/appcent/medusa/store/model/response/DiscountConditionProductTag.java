 ...
 */
@Schema(description = "Associates a discount condition with a product tag")
...
public class DiscountConditionProductTag {
  ...
  private String productTagId = null;
  ...
  public DiscountConditionProductTag productTagId(String productTagId) {
   ...
   * @return productTagId
  **/
  @Schema(example = "ptag_01F0YESHPZYY3H4SJ3A5918SBN", required = true, description = "The ID of the Product Tag")
  ...
  public DiscountConditionProductTag conditionId(String conditionId) {
  ...
  **/
  ...
  public DiscountConditionProductTag productTag(ProductTag productTag) {
  ...
  **/
  ...
  public DiscountConditionProductTag discountCondition(DiscountCondition discountCondition) {
  ...
  **/
  ...
  public DiscountConditionProductTag createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public DiscountConditionProductTag updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public DiscountConditionProductTag metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DiscountConditionProductTag discountConditionProductTag = (DiscountConditionProductTag) o;
    return Objects.equals(this.productTagId, discountConditionProductTag.productTagId) &&
        Objects.equals(this.conditionId, discountConditionProductTag.conditionId) &&
        Objects.equals(this.productTag, discountConditionProductTag.productTag) &&
        Objects.equals(this.discountCondition, discountConditionProductTag.discountCondition) &&
        Objects.equals(this.createdAt, discountConditionProductTag.createdAt) &&
        Objects.equals(this.updatedAt, discountConditionProductTag.updatedAt) &&
        Objects.equals(this.metadata, discountConditionProductTag.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productTagId, conditionId, productTag, discountCondition, createdAt, updatedAt, metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class DiscountConditionProductTag {\n");
    
    sb.append("    productTagId: ").append(toIndentedString(productTagId)).append("\n");

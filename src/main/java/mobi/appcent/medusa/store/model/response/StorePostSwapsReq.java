...
public class StorePostSwapsReq {
  @SerializedName("order_id")
  private String orderId = null;

  @SerializedName("return_items")
  private List<StorePostSwapsReqReturnItems> returnItems = new ArrayList<StorePostSwapsReqReturnItems>();

  @SerializedName("return_shipping_option")
  private String returnShippingOption = null;

  @SerializedName("additional_items")
  private List<StorePostSwapsReqAdditionalItems> additionalItems = new ArrayList<StorePostSwapsReqAdditionalItems>();

  public StorePostSwapsReq orderId(String orderId) {
   ...
   * @return orderId
  **/
  @Schema(required = true, description = "The ID of the Order to create the Swap for.")
  ...
  public StorePostSwapsReq returnItems(List<StorePostSwapsReqReturnItems> returnItems) {
    this.returnItems = returnItems;
    return this;
  }

  public StorePostSwapsReq addReturnItemsItem(StorePostSwapsReqReturnItems returnItemsItem) {
   ...
   * @return returnItems
  **/
  @Schema(required = true, description = "The items to include in the Return.")
  public List<StorePostSwapsReqReturnItems> getReturnItems() {
    return returnItems;
  }

  public void setReturnItems(List<StorePostSwapsReqReturnItems> returnItems) {
    this.returnItems = returnItems;
  }

  public StorePostSwapsReq returnShippingOption(String returnShippingOption) {
    this.returnShippingOption = returnShippingOption;
    return this;
  }
  ...
  **/
  @Schema(description = "The ID of the Shipping Option to create the Shipping Method from.")
  public String getReturnShippingOption() {
    return returnShippingOption;
  }

  public void setReturnShippingOption(String returnShippingOption) {
    this.returnShippingOption = returnShippingOption;
  }

  public StorePostSwapsReq additionalItems(List<StorePostSwapsReqAdditionalItems> additionalItems) {
    this.additionalItems = additionalItems;
    return this;
  }

  public StorePostSwapsReq addAdditionalItemsItem(StorePostSwapsReqAdditionalItems additionalItemsItem) {
  ...
  **/
  @Schema(required = true, description = "The items to exchange the returned items to.")
  public List<StorePostSwapsReqAdditionalItems> getAdditionalItems() {
    return additionalItems;
  }

  public void setAdditionalItems(List<StorePostSwapsReqAdditionalItems> additionalItems) {
    this.additionalItems = additionalItems;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StorePostSwapsReq storePostSwapsReq = (StorePostSwapsReq) o;
    return Objects.equals(this.orderId, storePostSwapsReq.orderId) &&
        Objects.equals(this.returnItems, storePostSwapsReq.returnItems) &&
        Objects.equals(this.returnShippingOption, storePostSwapsReq.returnShippingOption) &&
        Objects.equals(this.additionalItems, storePostSwapsReq.additionalItems);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orderId, returnItems, returnShippingOption, additionalItems);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorePostSwapsReq {\n");
    
    sb.append("    orderId: ").append(toIndentedString(orderId)).append("\n");
    sb.append("    returnItems: ").append(toIndentedString(returnItems)).append("\n");
    sb.append("    returnShippingOption: ").append(toIndentedString(returnShippingOption)).append("\n");

...
public class PricedVariantTaxRates {
  @SerializedName("rate")
  ...
  public PricedVariantTaxRates rate(BigDecimal rate) {
    this.rate = rate;
    return this;
  }
   ...
   * @return rate
  **/
  @Schema(description = "The tax rate value")
  ...
  public PricedVariantTaxRates name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @Schema(description = "The name of the tax rate")
  ...
  public PricedVariantTaxRates code(String code) {
    this.code = code;
    return this;
  }
   ...
   * @return code
  **/
  @Schema(description = "The code of the tax rate")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PricedVariantTaxRates pricedVariantTaxRates = (PricedVariantTaxRates) o;
    return Objects.equals(this.rate, pricedVariantTaxRates.rate) &&
        Objects.equals(this.name, pricedVariantTaxRates.name) &&
        Objects.equals(this.code, pricedVariantTaxRates.code);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rate, name, code);
  }
  ...
  public String toString() {
    ...
    sb.append("class PricedVariantTaxRates {\n");

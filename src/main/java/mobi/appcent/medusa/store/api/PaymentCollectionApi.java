...
import mobi.appcent.medusa.store.model.request.paymentcollection.*;
...
public class PaymentCollectionApi {
    ...
    public static PaymentCollectionApi getInstance() {
        return new PaymentCollectionApi();
    }
     ...
     * expand Comma separated list of relations to include in the results. (optional)
     * fields Comma separated list of fields to include in the results. (optional)
     * @return StorePaymentCollectionsRes
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GetPaymentCollectionRequest getPaymentCollection(String id) throws ApiException {
        return new GetPaymentCollectionRequest(medusaSdkClient, id);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public RefreshPaymentSessionRequest refreshPaymentSession(String id, String sessionId) throws ApiException {
        return new RefreshPaymentSessionRequest(medusaSdkClient, id, sessionId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ManagePaymentSessionsRequest managePaymentSessions(String id) throws ApiException {
        return new ManagePaymentSessionsRequest(medusaSdkClient, id);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ManagePaymentSessionRequest managePaymentSession(String id) throws ApiException {
        return new ManagePaymentSessionRequest(medusaSdkClient, id);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AuthorizePaymentSessionsRequest authorizePaymentSessions(String id) throws ApiException {
        return new AuthorizePaymentSessionsRequest(medusaSdkClient, id);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AuthorizePaymentSessionRequest authorizePaymentSession(String id, String sessionId) throws ApiException {
        return new AuthorizePaymentSessionRequest(medusaSdkClient, id, sessionId);
    }
}
